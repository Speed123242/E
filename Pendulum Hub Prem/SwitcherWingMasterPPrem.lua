--     -gh 4315489767,4794315940,4506945409,4458601937,4524991457,4820152700,4932541287,4773932088
loadstring(game:HttpGet("https://raw.githubusercontent.com/Tescalus/Pendulum-Hubs-Source/main/ReanimMain.lua"))()

game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory").Name = "Sword1"
game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory").Name = "Sword2"
game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory").Name = "Sword3"
game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory").Name = "Sword4"
game.Players.LocalPlayer.Character:FindFirstChild("BladeMasterAccessory").Name = "Sword5"
game.Players.LocalPlayer.Character:FindFirstChild("ShadowBladeMasterAccessory").Name = "Sword6"
game.Players.LocalPlayer.Character:FindFirstChild("swordhalo").Name = "Halo"
game.Players.LocalPlayer.Character:FindFirstChild("Evil Aura").Name = "Aura"
...
function explodemines()
	for i, v in pairs(DebrisModel:GetChildren()) do
		if v.Name == "MINE" then
			...
			sound(0, v.Position, 10, math.random(180, 230) / 100)
...
---------------EDIT SECTION--------------------------
game.Players.LocalPlayer.Character.wings:FindFirstChild("Part").Name = "Part1"
game.Players.LocalPlayer.Character.wings:FindFirstChild("Part").Name = "Part2"
game.Players.LocalPlayer.Character.wings:FindFirstChild("Part").Name = "Part3"
game.Players.LocalPlayer.Character.wings:FindFirstChild("Part").Name = "Part4"
game.Players.LocalPlayer.Character.wings:FindFirstChild("Part").Name = "Part5"
game.Players.LocalPlayer.Character.wings:FindFirstChild("Part").Name = "Part6"
...
local hat = Align(char['Sword1'].Handle,game:GetService("Workspace").non.wings.Part1,false)
local cf = game:GetService("Workspace").non.wings.Part1.CFrame*CFrame.new(2,-2,0)*CFrame.Angles(math.rad(0),math.rad(0),-130)
hat[1].CFrame = cf:Inverse() * game:GetService("Workspace").non.wings.Part1.CFrame
spawn(function()
...
local hat = Align(char['Sword2'].Handle,game:GetService("Workspace").non.wings.Part2,false)
local cf = game:GetService("Workspace").non.wings.Part2.CFrame*CFrame.new(2,-2,0)*CFrame.Angles(math.rad(0),math.rad(0),-130.30)
hat[1].CFrame = cf:Inverse() * game:GetService("Workspace").non.wings.Part2.CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
end)
...
local hat = Align(char['Sword3'].Handle,game:GetService("Workspace").non.wings.Part4,false)
local cf = game:GetService("Workspace").non.wings.Part3.CFrame*CFrame.new(2,-2,0)*CFrame.Angles(math.rad(0),math.rad(0),-130)
hat[1].CFrame = cf:Inverse() * game:GetService("Workspace").non.wings.Part3.CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
end)
...
local hat = Align(char['Sword4'].Handle,game:GetService("Workspace").non.wings.Part5,false)
local cf = game:GetService("Workspace").non.wings.Part4.CFrame*CFrame.new(2,-2,0)*CFrame.Angles(math.rad(0),math.rad(0),-130.30)
hat[1].CFrame = cf:Inverse() * game:GetService("Workspace").non.wings.Part4.CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
end)
...
local hat = Align(char['Sword5'].Handle,game:GetService("Workspace").non.wings.Part3,false)
local cf = game:GetService("Workspace").non.wings.Part3.CFrame*CFrame.new(2,-2,0)*CFrame.Angles(math.rad(0),math.rad(0),-130.30)
hat[1].CFrame = cf:Inverse() * game:GetService("Workspace").non.wings.Part3.CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
...
local hat = Align(char['Sword6'].Handle,game:GetService("Workspace").non.wings.Part6,false)
local cf = game:GetService("Workspace").non.wings.Part6.CFrame*CFrame.new(2,-2,0)*CFrame.Angles(math.rad(0),math.rad(0),-130.30)
hat[1].CFrame = cf:Inverse() * game:GetService("Workspace").non.wings.Part6.CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
end)
...
local hat = Align(char['Halo'].Handle,char['Torso'],false)
local cf = char['Torso'].CFrame*CFrame.new(0,4,0.25)*CFrame.Angles(math.rad(0),math.rad(0),0)
...
local hat = Align(char['Aura'].Handle,char['Torso'],false)
local cf = char['Torso'].CFrame*CFrame.new(0,3.50,0.25)*CFrame.Angles(math.rad(0),math.rad(0),0)
hat[1].CFrame = cf:Inverse() * char['Torso'].CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
