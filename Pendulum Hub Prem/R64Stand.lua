game.Players:Chat("-gh 7394702369,29532720,62724852,48474294,451220849,63690008,11679229,11142504,12548563,20011897")
...
game:GetService("Workspace").non.Stand.Part.Name = "Torso"

game:GetService("Workspace").non.Stand.Part.Name = "Head"

game:GetService("Workspace").non.Stand.Part.Name = "LArm"

game:GetService("Workspace").non.Stand.Part.Name = "RArm"

game:GetService("Workspace").non.Stand.Part.Name = "LArm"

game:GetService("Workspace").non.Stand.Part.Name = "LLeg"

game:GetService("Workspace").non.Stand.Part.Name = "Hair"

game:GetService("Workspace").non.Stand.Part.Name = "Useless"
game:GetService("Workspace").non.Stand.Part.Name = "RLeg"
...
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["Pal Hair"].Handle.Mesh:Destroy()
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["Pink Hair"].Handle.Mesh:Destroy()
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["LavanderHair"].Handle.Mesh:Destroy()
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["Kate Hair"].Handle.Mesh:Destroy()
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["SeeMonkey"].Handle.Mesh:Destroy()
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["Racing Helmet Flames"].Handle.Mesh:Destroy()
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["Racing Helmet"].Handle.Mesh:Destroy()
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["Space Cop"].Handle.Mesh:Destroy()
game:GetService("Workspace").non[game.Players.LocalPlayer.Name]["SpaceHelmetB"].Handle.Mesh:Destroy()
--align Pal hair LARM
local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["SpaceHelmetB"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)

Weld.Part1 = hat -- (Hat)
Weld.Part0 = game:GetService("Workspace").non.Stand.Torso -- What your welding the hat to (has to be a BasePart)

Weld.C0 = CFrame.new(-0.70,-1,0.60)*CFrame.Angles(math.rad(90),math.rad(0),0) -- Angles
print("Ran with no errors")

local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["Space Cop"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)
...
local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["Pal Hair"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)

Weld.Part1 = hat -- (Hat)
Weld.Part0 = game:GetService("Workspace").non.Stand.LArm -- What your welding the hat to (has to be a BasePart)
...
local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["adorableskinmask"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)

Weld.Part1 = hat -- (Hat)
Weld.Part0 = game:GetService("Workspace").non.Stand.Head -- What your welding the hat to (has to be a BasePart)
...
local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["Pink Hair"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)

Weld.Part1 = hat -- (Hat)
Weld.Part0 = game:GetService("Workspace").non.Stand.RArm -- What your welding the hat to (has to be a BasePart)
...
local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["LavanderHair"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)

Weld.Part1 = hat -- (Hat)
Weld.Part0 = game:GetService("Workspace").non.Stand.LLeg -- What your welding the hat to (has to be a BasePart)
...
local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["Kate Hair"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)
...
Weld.C0 = CFrame.new(1,0,0)*CFrame.Angles(math.rad(90),math.rad(0),0) -- Angles
print("Ran with no errors")

local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["SeeMonkey"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)
...
local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["Racing Helmet Flames"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)
...
Weld.C0 = CFrame.new(0.45,0.60,-0.70)*CFrame.Angles(math.rad(90),math.rad(0),0) -- Angles
print("Ran with no errors")

local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["Racing Helmet"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
-- Tips for past John (Tescalus)
