...
local StarGlitcher = CreateInstance('ScreenGui',{DisplayOrder=0,Enabled=true,ResetOnSpawn=true,Name='StarGlitcher', Parent=game.CoreGui})
local Frame = CreateInstance('Frame',{Style=Enum.FrameStyle.Custom,Active=false,AnchorPoint=Vector2.new(0, 0),BackgroundColor3=Color3.new(1, 1, 1),BackgroundTransparency=0,BorderColor3=Color3.new(0.105882, 0.164706, 0.207843),BorderSizePixel=1,ClipsDescendants=false,Draggable=false,Position=UDim2.new(0.0287443269, 0, 0.506766915, 0),Rotation=0,Selectable=false,Size=UDim2.new(0, 212, 0, 79),SizeConstraint=Enum.SizeConstraint.RelativeXY,Visible=true,ZIndex=1,Name = 'Frame',Parent = StarGlitcher})
local TextLabel = CreateInstance('TextLabel',{Font=Enum.Font.SourceSans,FontSize=Enum.FontSize.Size14,Text='Label',TextColor3=Color3.new(0, 0, 0),TextScaled=true,TextSize=14,TextStrokeColor3=Color3.new(0, 0, 0),TextStrokeTransparency=1,TextTransparency=0,TextWrapped=true,TextXAlignment=Enum.TextXAlignment.Center,TextYAlignment=Enum.TextYAlignment.Center,Active=false,AnchorPoint=Vector2.new(0, 0),BackgroundColor3=Color3.new(1, 1, 1),BackgroundTransparency=0,BorderColor3=Color3.new(0.105882, 0.164706, 0.207843),BorderSizePixel=1,ClipsDescendants=false,Draggable=false,Position=UDim2.new(0.0283018872, 0, 0.177215189, 0),Rotation=0,Selectable=false,Size=UDim2.new(0, 200, 0, 50),SizeConstraint=Enum.SizeConstraint.RelativeXY,Visible=true,ZIndex=1,Name='TextLabel',Parent = Frame})
...
local function blackhole()
 local A_9 = getrenv()._G.Pass
                        local A_10 = game.Players.LocalPlayer.Backpack.Main.LockOnScript.LockOn.Value
                        local A_11 = 
                            {
                                ["HitTime"] = 1,
                                ["Type"] = "Knockback", 
                        ...
                        local Eventp = game:GetService("ReplicatedStorage").Remotes.Damage
                        Eventp:InvokeServer(A_9, A_10, A_11)
end
...
Sound.Playing = true
Sound.Looped = true
Sound.SoundId = "rbxassetid://614032233" 
Sound.Name = "glitcher jajajajaja"
...
userInputService.InputBegan:Connect(function(input,gameProcessedEvent)
    local keyPressed = input.KeyCode
      ...
      if not gameProcessedEvent then
          if keyPressed == Enum.KeyCode.Z then
              if ModeBind == 2 then
local Anim = Instance.new("Animation") Anim.AnimationId = "rbxassetid://7004737889" local k = game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(Anim) k:Play() k:AdjustSpeed(1)
...
Sound.Playing = true
Sound.Looped = true
Sound.SoundId = "rbxassetid://925192139" 
Sound.Name = "divinity jajajajaja"
...
local Player = game.Players.LocalPlayer
ModeColor = Color3.new(0.6,15,0.5)
...
Sound.Playing = true
Sound.Looped = true
Sound.SoundId = "rbxassetid://5567840141" 
Sound.Name = "catastrophe jajajajaja"
...
game:GetService("ReplicatedStorage").Remotes.Functions:InvokeServer(unpack(args))
local Player = game.Players.LocalPlayer
ModeColor = Color3.fromRGB(102, 15, 168)

ModeName = "CATASTROPHE"
Mode = 3
wait(1)
    ...
    local keyPressed = input.KeyCode
      ...
      if not gameProcessedEvent then
          if keyPressed == Enum.KeyCode.E then
            ...
            if ModeBind == 1 then
                TextLabel.Text = "Mayhem"
            elseif ModeBind == 2 then
                TextLabel.Text = "Divinity"
            elseif ModeBind == 3 then
                TextLabel.Text = "Catastrophe"
            end
...
local Event = game:GetService("ReplicatedStorage").Remotes.Events
Event:FireServer(A_1)
        game.Players.LocalPlayer.Backpack.Main.WalkSpeed.Value = 420
game.Players.LocalPlayer.Backpack.Main.RunSpeed.Value = 690
    wait(5)
    GodSpeed = false
...
[5] = CFrame.Angles(0, 0, math.rad(i))})
end
local A_1 = 
{   
    [1] = getrenv()._G.Pass,
