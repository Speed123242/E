...
--start of script. Remove the wait function when executing on synapse
plr = game.Players.LocalPlayer
char = plr.Character
if char:FindFirstChild('Animate') then
	char:FindFirstChild('Animate'):Destroy() -- we handle the animation elsewhere
end

shirt = char.Shirt
origtemplate = shirt.ShirtTemplate
pants = char.Pants
panttemplate = pants.PantsTemplate
hum = char.Humanoid
mouse = plr:GetMouse()
...
kan.PlaybackSpeed = 1
kan.Pitch = 1
kan.SoundId = "rbxassetid://2717554604"
kan.Name = "wrecked"
kan.Looped = true
kan:Play()
local TimePosit = kan.TimePosition
...
modet.Font = "Fantasy"
modet.TextStrokeColor3 = Color3.new(1,0,1)
modet.TextColor3 = Color3.new(1,0.5,1)
modet.Text = "Converted By Pendulum Premium"
...
function bosschatfunc(text,color,watval)
	for i,v in pairs(game:GetService("Players"):GetPlayers()) do
		coroutine.resume(coroutine.create(function()
			...
			txtlb2.Text = "Skylar, The Loyalist"
			txtlb2.Font = "Arcade"
...
local halocolor = BrickColor.new("Converted By Pendulum Premium light blue")
...
ned.TextStrokeColor3 = BrickColor.new("Hot pink").Color
ned.TextScaled = true
ned.TextStrokeTransparency = 0
ned.Text = "Converted By Pendulum Premium"
ned.TextSize = 24
ned.Rotation = 1
...
tl1.Color = ColorSequence.new(BrickColor.new('Pink').Color)
tl1.Lifetime = 0.6
...
tl2.Color = ColorSequence.new(BrickColor.new('Pink').Color)
tl2.Lifetime = 0.6
...
tl3.Color = ColorSequence.new(BrickColor.new('Pink').Color)
tl3.Lifetime = 0.6
...
tr1.Color = ColorSequence.new(BrickColor.new('Pink').Color)
tr1.Lifetime = 0.6
...
tr2.Color = ColorSequence.new(BrickColor.new('Pink').Color)
tr2.Lifetime = 0.6
...
tr3.Color = ColorSequence.new(BrickColor.new('Pink').Color)
tr3.Lifetime = 0.6
...
local MAINRUINCOLOR = BrickColor.new("Pink")
------
...
function Triangle(a, b, c)
	...
	if len1 > 0.01 then
		...
		w1.BrickColor = BrickColor.new("Pink")
		w1.Transparency = 0
		w1.Reflectance = 0
		w1.Material = "SmoothPlastic"
		w1.CanCollide = false
	...
	if len2 > 0.01 then
		...
		w2.BrickColor = BrickColor.new("Pink")
		w2.Transparency = 0
		w2.Reflectance = 0
		w2.Material = "SmoothPlastic"
		w2.CanCollide = false
...
function Damagefunc(Part, hit, minim, maxim, knockback, Type, Property, Delay, HitSound, HitPitch)
	...
	if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Head") ~= nil then
		...
		elseif Type == "Leech" then
			...
			if hum ~= nil then
				for i = 0, 2 do
					Effects.Sphere.Create(BrickColor.new("Hot pink"), hit.Parent.Torso.CFrame * cn(0, 0, 0) * angles(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 15, 1, 0, 5, 0, 0.02)
				end
		...
		elseif Type == "Slashnare" then
			Effects.Block.Create(BrickColor.new("Converted By Pendulum Premium Blue"), hit.Parent.Torso.CFrame * cn(0, 0, 0), 15*4, 15*4, 15*4, 3*4, 3*4, 3*4, 0.07)
	...
	for _, c in pairs(workspace:children()) do
		...
		if hum ~= nil then
			...
			if head ~= nil then
				...
				local mag = targ.magnitude
				if magni >= mag and c.Name ~= Player.Name then
					MagicBlock(BrickColor.new("Converted By Pendulum Premium light blue"),head.CFrame,5,5,5,1,1,1,0.05)
					Damagefunc(head, head, mindam, maxdam, knock, Type, RootPart, 0.1, "rbxassetid://231917784", 1)
				end
			end
		end
...
local origcolor = BrickColor.new("Converted By Pendulum Premium light blue")
...
function GoddessJump()
	attack = true
	hum.WalkSpeed = 0
	sphere2(5,"Add",root.CFrame,vt(1,1,1),1.5,1.5,1.5,BrickColor.new("Pink"),BrickColor.new("Pink").Color)
	sphere2(5,"Add",root.CFrame,vt(1,1,1),1,1,1,BrickColor.new("Hot pink"),BrickColor.new("Hot pink").Color)
	CFuncs["Sound"].Create("rbxassetid://2219743129", root, 7.5, 1)
	for i = 0, 2, 0.1 do
		swait()
		root.Velocity = vt(0,0,0)
		slash(math.random(50,100)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(0.05,0.01,0.05),math.random(25,250)/250,BrickColor.new("White"))
	...
	MagniDamage(root, 28, 25,50, 25, "Normal")
	CFuncs["Sound"].Create("rbxassetid://952179983", char, 17, 1)
	hum.Jump = true
	swait()
	root.Velocity = vt(0,250,0) + root.CFrame.lookVector*250
	sphere2(5,"Add",root.CFrame*CFrame.Angles(math.rad(-45),0,0),vt(25,1,25),0.3,5,0.3,BrickColor.new("Pink"),BrickColor.new("Pink").Color)
	sphere2(5,"Add",root.CFrame*CFrame.Angles(math.rad(-45),0,0),vt(25,1,25),0.2,4,0.2,BrickColor.new("Hot pink"),BrickColor.new("Hot pink").Color)
	CFuncs["Sound"].Create("rbxassetid://741272936", root, 10, 1)
	for i = 0, 3, 0.1 do
		swait()
		RH.C0=clerp(RH.C0,cf(1,-0.45,-0.45)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0),math.rad(-20)),.4)
		LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(0),math.rad(30)),.4)
...
function CalamityJump()
	attack = true
	hum.WalkSpeed = 0
	sphere2(5,"Add",root.CFrame,vt(1,1,1),1.5,1.5,1.5,MAINRUINCOLOR,MAINRUINCOLOR.Color)
	sphere2(5,"Add",root.CFrame,vt(1,1,1),1,1,1,MAINRUINCOLOR,MAINRUINCOLOR.Color)
	CFuncs["Sound"].Create("rbxassetid://2219743129", root, 7.5, 1)
	for i = 0, 2, 0.1 do
		swait()
		root.Velocity = vt(0,0,0)
	...
	MagniDamage(root, 28, 25,50, 25, "Normal")
	CFuncs["Sound"].Create("rbxassetid://0", char, 17, 1)
	hum.Jump = true
	swait()
	root.Velocity = vt(0,250,0) + root.CFrame.lookVector*250
	sphere2(5,"Add",root.CFrame*CFrame.Angles(math.rad(-45),0,0),vt(25,1,25),0.3,5,0.3,MAINRUINCOLOR,MAINRUINCOLOR.Color)
	sphere2(5,"Add",root.CFrame*CFrame.Angles(math.rad(-45),0,0),vt(25,1,25),0.2,4,0.2,MAINRUINCOLOR,MAINRUINCOLOR.Color)
	CFuncs["Sound"].Create("rbxassetid://741272936", root, 10, 1)
	for i = 0, 3, 0.1 do
		swait()
		RH.C0=clerp(RH.C0,cf(1,-0.45,-0.45)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0),math.rad(-20)),.4)
...
game:GetService("RunService").Stepped:Connect(function()
	if ModeOfGlitch  == 9999999921111 then  
		hum.WalkSpeed = 16
	end
	if ModeOfGlitch ~= 9999999921111 then return
	...
	elseif TORSOVELOCITY < 1 and HITFLOOR ~= nil then
		...
		if ATTACK == false then
			...
			RightShoulder.C0 = Clerp(RightShoulder.C0, CF(1.25*SIZE, 0.5*SIZE, 0.8*SIZE) * ANGLES(RAD(-35), RAD(-25 + 2.5 * SIN(SINE / 12)), RAD(-55 + 2.5 * SIN(SINE / 12))) * RIGHTSHOULDERC0, 1 / Animation_Speed)
			LeftShoulder.C0 = Clerp(LeftShoulder.C0, CF(-1.25*SIZE, 0.5*SIZE, 0.8*SIZE) * ANGLES(RAD(-35), RAD(25 - 2.5 * SIN(SINE / 12)), RAD(55 - 2.5 * SIN(SINE / 12))) * LEFTSHOULDERC0, 1 / Animation_Speed)
	...
	elseif TORSOVELOCITY > 1 and HITFLOOR ~= nil then
		...
		if ATTACK == false then
			...
			RightShoulder.C0 = Clerp(RightShoulder.C0, CF(1.25*SIZE, 0.5*SIZE, 0.8*SIZE) * ANGLES(RAD(-35), RAD(-25 + 2.5 * SIN(SINE / WALKSPEEDVALUE)), RAD(-55 + 2.5 * SIN(SINE / WALKSPEEDVALUE))) * RIGHTSHOULDERC0, 1 / Animation_Speed)
			LeftShoulder.C0 = Clerp(LeftShoulder.C0, CF(-1.25*SIZE, 0.5*SIZE, 0.8*SIZE) * ANGLES(RAD(-35), RAD(25 - 2.5 * SIN(SINE / WALKSPEEDVALUE)), RAD(55 - 2.5 * SIN(SINE / WALKSPEEDVALUE))) * LEFTSHOULDERC0, 1 / Animation_Speed)
...
function Nova()
	...
	for i = 0, 5, 0.1 do
		...
		PixelBlockNeg(2,1,"Add",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.01,BrickColor.new("Bright blue"),0)
		RH.C0=clerp(RH.C0,cf(1,-1 - 0.1 * math.cos(sine / 32),0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(0),math.rad(0),math.rad(-2 - 1 * math.cos(sine / 32))),.1)
		LH.C0=clerp(LH.C0,cf(-1,-1 - 0.1 * math.cos(sine / 32),0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3 + 1 * math.cos(sine / 32)),math.rad(0),math.rad(-10)),.1)
		RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,0 + 0.1 * math.cos(sine / 32))*angles(math.rad(0),math.rad(0),math.rad(0)),.1)
		Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(0),math.rad(0),math.rad(0)),.1)
	...
	coroutine.resume(coroutine.create(function()
		...
		local hit =orb.Touched:connect(function(hit) 
			if hitted == false then
				...
				CFuncs["Sound"].Create("rbxassetid://151304356", orb, 5,1)
				MagniDamage(orb, 65, 65,90, 0, "Normal")
				sphere(1,"Add",orb.CFrame,vt(orbm.Scale.x,orbm.Scale.y,orbm.Scale.z),1,BrickColor.new("Pink"))
				sphere(2,"Add",orb.CFrame,vt(orbm.Scale.x,orbm.Scale.y,orbm.Scale.z),2,BrickColor.new("Pink"))
				for i = 0, 49 do
					PixelBlock(1,math.random(1,30),"Add",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),4,4,4,0.08,BrickColor.new("Bright blue"),0)
				end
				for i = 0, 9 do
					sphereMK(1,2.5,"Add",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),5,5,50,-0.05,BrickColor.new("Pink"),0)
					sphereMK(2,5,"Add",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),5,5,50,-0.05,BrickColor.new("Pink"),0)
				end
				orb.Anchored = true
				orb.Transparency = 1
				wait(8)
...
function nightstalker()
	attack = true
	hum.WalkSpeed = 0
	newTheme("rbxassetid://298376517",0,1,40)
	wait(3.18)
	bosschatfunc("What does it mean to be a hunter?",MAINRUINCOLOR.Color,9)
	wait(6.05-3.18)
	bosschatfunc("I'd say its all about where you belong",MAINRUINCOLOR.Color,7)
	wait(9.15-6.05)
	bosschatfunc("The Warlocks have their libraries",MAINRUINCOLOR.Color,7)
	wait(11.17-9.15)
	bosschatfunc("The Titans have their walls",MAINRUINCOLOR.Color,7)
	wait(14.05-11.17)
	bosschatfunc("But Hunters belong in the wilds",MAINRUINCOLOR.Color,7)
	wait(16.17-14.05)
	bosschatfunc("Out there, you wanna live?",MAINRUINCOLOR.Color,3)
	wait(18.11-16.17)
	bosschatfunc("You better have a quick shot or a sharp blade",MAINRUINCOLOR.Color,5)
	wait(21.15-18.11)
	bosschatfunc("Lot of us are loners but that's not the only path",MAINRUINCOLOR.Color,5)
	wait(25.10-21.15)
	bosschatfunc("Some of us know the difference a fireteam makes",MAINRUINCOLOR.Color,5)
	wait(3.9)
	bosschatfunc("Some of us, we touch the Void, make it a part of us",MAINRUINCOLOR.Color,5)
	wait(34-29)
	bosschatfunc("Then we take a name, 'Nightstalker'",MAINRUINCOLOR.Color,5)
	wait(3.18)
	bosschatfunc("Hunt from the shadows, pin them down",MAINRUINCOLOR.Color,5)
	wait(40.13-37.18)
	bosschatfunc("Never let them see you coming",MAINRUINCOLOR.Color,5)
	attack = false
	hum.WalkSpeed = storehumanoidWS
end
...
function taunt()
	...
	coroutine.resume(coroutine.create(function()
		for i = 1,40 do
			swait()
			RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 - 0.04 * math.sin(sine / 24), 0 + 0.04 * math.sin(sine / 12), 0 + 0.05 * math.cos(sine / 12)) * angles(math.rad(0 - 2.5 * math.sin(sine / 12)), math.rad(0 - 2.5 * math.sin(sine / 24)), math.rad(0)), .1)
			Torso.Neck.C0=clerp(Torso.Neck.C0,necko* cf(0, 0, 0 + ((1.1) - 1)) * angles(math.rad(5), math.rad(0), math.rad(-45)), .1)
			RW.C0= RW.C0:Lerp(CFrame.new(1.5,1,0)*CFrame.Angles(math.rad(-220), math.rad(-70), math.rad(-0)), .35)
			LW.C0=clerp(LW.C0,cf(-1.25, 0.5, 0.5) * angles(math.rad(-35), math.rad(25 - 2.5 * math.sin(sine / 12)), math.rad(55 - 2.5 * math.sin(sine / 12))), .1)
			RW.C0=clerp(RW.C0,cf(1, -1 + 0.06 * math.sin(sine / 24) - 0.05 * math.cos(sine / 12), -0.01) * angles(math.rad(0 - 2.5 * math.sin(sine / 12)), math.rad(75), math.rad(0)) * angles(math.rad(-2 - 2.5 * math.sin(sine / 24)), math.rad(0), math.rad(0)), .1)
			LH.C0=clerp(LH.C0,cf(-1, -1 - 0.06 * math.sin(sine / 24) - 0.05 * math.cos(sine / 12), -0.01) * angles(math.rad(0 - 2.5 * math.sin(sine / 12)), math.rad(-75), math.rad(0)) * angles(math.rad(-2 + 2.5 * math.sin(sine / 24)), math.rad(0), math.rad(0)), .1)
		end
		coroutine.resume(coroutine.create(function()
			for i = 1,4 do
				swait()

				RW.C0= RW.C0:Lerp(CFrame.new(1.5,1,0)*CFrame.Angles(math.rad(-220), math.rad(-150), math.rad(-0)), .35)
			end
		end))
		repeat
			swait()
			LAUGH.Parent = Head
			RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 - 0.04 * math.sin(sine / 24), 0 + 0.04 * math.sin(sine / 12), 0+(0.1*75) + 0.05 * math.cos(sine / 12)) * angles(math.rad(0 - 2.5 * math.sin(sine / 12)), math.rad(0 - 2.5 * math.sin(sine / 24)), math.rad(0)), .1)
			Torso.Neck.C0=clerp(Torso.Neck.C0,necko* cf(0, 0, 0 + ((1.1+(0.1*75)) - 1)) * angles(math.rad(5), math.rad(0), math.rad(-45)), .1)
			RW.C0=clerp(RW.C0,cf(1.25, 0.15+(0.1*75), -0.5) * angles(math.rad(170), math.rad(-25), math.rad(-15)), .1)
			LW.C0=clerp(LW.C0,cf(-1.25, 0.5+(0.1*75), 0.5) * angles(math.rad(-35), math.rad(25 - 2.5 * math.sin(sine / 12)), math.rad(55 - 2.5 * math.sin(sine / 12))), .1)
			RW.C0=clerp(RW.C0,cf(1, -1-(0.1*75) + 0.06 * math.sin(sine / 24) - 0.05 * math.cos(sine / 12), -0.01) * angles(math.rad(0 - 2.5 * math.sin(sine / 12)), math.rad(75), math.rad(0)) * angles(math.rad(-2 - 2.5 * math.sin(sine / 24)), math.rad(0), math.rad(0)), .1)
			LH.C0=clerp(LH.C0,cf(-1, -1-(0.1*75) - 0.06 * math.sin(sine / 24) - 0.05 * math.cos(sine / 12), -0.01) * angles(math.rad(0 - 2.5 * math.sin(sine / 12)), math.rad(-75), math.rad(0)) * angles(math.rad(-2 + 2.5 * math.sin(sine / 24)), math.rad(0), math.rad(0)), .1)
		until LAUGH.Playing == false
	end))

	CFuncs["Sound"].Create("rbxassetid://174879839", char, 9,1)
	attack = false
	hum.WalkSpeed = storehumanoidWS
end
			...
			for i, v in pairs(FindNearestHead(hb.CFrame.p, 1.25)) do
				if v:FindFirstChild('Head') then
					if alreadydid == false then
						...
						elseif radm == 2 then
							bosschatfunc("I can help heal wounds",MAINRUINCOLOR.Color,1)
						elseif radm == 3 then
				...
				if v:FindFirstChild('Head') then
					if alreadydid == false then
						...
						if radm == 1 then
							bosschatfunc("I'm sorry.. if I hurt you...",MAINRUINCOLOR.Color,1)
						elseif radm == 2 then
							bosschatfunc("I will be with you soon...",MAINRUINCOLOR.Color,1)
						elseif radm == 3 then
							bosschatfunc("I'm sorry. I failed you all...",MAINRUINCOLOR.Color,1)
						end
						root.Anchored = true
						coroutine.resume(coroutine.create(function()
							huggedperson.Humanoid.WalkSpeed = 0
...
function harmonytaunty()
	attack = true
	hum.WalkSpeed = 0
	CFuncs["Sound"].Create("rbxassetid://1155326706", root, 9, 1)
	bosschatfunc("Nice try",MAINRUINCOLOR.Color,9)
	for i = 0,7,0.1 do
		swait()
...
function loveydovey()
	...
	for i = 0, 24 do
		slash(math.random(10,50)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,500)/250,BrickColor.new("Converted By Pendulum Premium yellow"))
	end
	for i = 0, 49 do
	...
	newTheme("rbxassetid://631404940",0,1,2)
	ModeOfGlitch = 9600000000
	MAINRUINCOLOR = BrickColor.new("Converted By Pendulum Premium violet")
	for i = 0, 1, 0.2 do
		swait()
	...
	sphere2(2,"Add",root.CFrame,vt(5,5,5),0.75,0.75,0.75,BrickColor.new("Converted By Pendulum Premium violet"))
	sphere2(2,"Add",root.CFrame,vt(5,5,5),1,1,1,BrickColor.new("Converted By Pendulum Premium violet"))
	...
	sphere2(1,"Add",root.CFrame,vt(5,10000,5),0.5,0.5,0.5,BrickColor.new("Converted By Pendulum Premium violet"))
	...
	for i = 0, 49 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,500)/250,BrickColor.new("Converted By Pendulum Premium yellow"))
	end
	for i = 0, 49 do
		local rsiz = math.random(70,90)
		...
		sphereMK(math.random(1,2),math.random(1,3),"Add",root.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Converted By Pendulum Premium violet"),0)
	end
	CFuncs["Sound"].Create("rbxassetid://847061203", char, 1,1)
	for i = 0, 1, 0.2 do
		swait()
	...
	sphere2(4,"Add",root.CFrame,vt(5,5,5),1,1,1,BrickColor.new("Converted By Pendulum Premium violet"))
	sphere2(4,"Add",root.CFrame,vt(5,5,5),2,2,2,BrickColor.new("Converted By Pendulum Premium violet"))
	...
	sphere2(1,"Add",root.CFrame,vt(5,5,5),2,2,2,BrickColor.new("Converted By Pendulum Premium violet"))
	sphere2(1,"Add",root.CFrame,vt(5,5,5),3,3,3,BrickColor.new("Converted By Pendulum Premium violet"))
	sphere2(1,"Add",root.CFrame,vt(5,5,5),4,4,4,BrickColor.new("Converted By Pendulum Premium violet"))
	sphere2(1,"Add",root.CFrame,vt(5,10000,5),2.5,2.5,2.5,BrickColor.new("Converted By Pendulum Premium violet"))
	sphere2(2,"Add",root.CFrame,vt(5,10000,5),3.5,3.5,3.5,MAINRUINCOLOR)
	sphere2(1,"Add",root.CFrame,vt(5,5,5),8,8,8,BrickColor.new("Converted By Pendulum Premium violet"))
	sphere2(2,"Add",root.CFrame,vt(5,5,5),14,14,14,MAINRUINCOLOR)
	sphere2(3,"Add",root.CFrame,vt(5,5,5),20,20,20,MAINRUINCOLOR)
	for i = 0, 99 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,2500)/250,BrickColor.new("Converted By Pendulum Premium yellow"))
	end
	for i = 0, 99 do
		local rsiz = math.random(150,450)
		sphere2(math.random(1,4),"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(15,1,15),-0.05,math.random(25,500)/25,-0.05,BrickColor.new("Converted By Pendulum Premium violet"))
		...
		sphereMK(math.random(1,2),math.random(4,6),"Add",root.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Converted By Pendulum Premium violet"),0)
	end
	coroutine.resume(coroutine.create(function()
		local eff = Instance.new("ParticleEmitter",root)
		eff.Texture = "rbxassetid://749327003"
		eff.LightEmission = 1
		eff.Color = ColorSequence.new(BrickColor.new("Converted By Pendulum Premium violet").Color)
		eff.Rate = 50000
		eff.Lifetime = NumberRange.new(5)
	...
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Miku Izayoi True Form",BrickColor.new("Converted By Pendulum Premium yellow").Color,BrickColor.new("Converted By Pendulum Premium violet").Color,"Cartoon")
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Converted By Pendulum Premium yellow"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	for i = 0, 2, 0.1 do
		swait()
...
function CalamitasG()
	...
	for i = 0, 49 do
		...
		slash(math.random(50,100)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(poste/100,0.01,poste/100),poste/50,BrickColor.new("Really red"))
	...
	ModeOfGlitch = 6000000001
	storehumanoidWS = 300
	hum.WalkSpeed = 300
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Skylar, The Bitch Pendulum Skid! (Grief)",BrickColor.new("Really red").Color,BrickColor.new("Bright red").Color,"Highway")
	newThemeCust("rbxassetid://2557063996",0,1,3)
	...
	shirt.ShirtTemplate = origtemplate
	pants.PantsTemplate = "rbxassetid://2129356710"
	wait(1.3)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Couldn't Leave us well enough alone, could you?",MAINRUINCOLOR.Color,9)
	wait(2.4)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Everything was going well until you came along.",MAINRUINCOLOR.Color,9)
	wait(2.4)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Fine, let's settle this.",MAINRUINCOLOR.Color,9)
	wait(2.4)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("NOW!",MAINRUINCOLOR.Color,9)
	wait(1.2)
	...
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,BrickColor.new("Bright red"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,keptcolor)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Really red"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Bright red"))
	...
	hum.WalkSpeed = storehumanoidWS
	for i = 0, 99 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,2500)/250,BrickColor.new("Really red"))
	end
	for i = 0, 49 do
		local rsiz = math.random(150,450)
		sphere2(math.random(1,4),"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(15,1,15),-0.05,math.random(25,500)/25,-0.05,BrickColor.new("Bright red"))
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))*CFrame.new(math.random(-350,350),math.random(-350,350),math.random(-350,350)),vt(1,1,1),-0.01,math.random(50,250)/10,-0.01,BrickColor.new("Bright red"))
		sphereMK(math.random(1,2),math.random(2,4),"Add",x.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Really red"),0)
	end
	coroutine.resume(coroutine.create(function()
		local eff = Instance.new("ParticleEmitter",x)
		eff.Texture = "rbxassetid://2273224484"
		eff.LightEmission = 1
		eff.Color = ColorSequence.new(BrickColor.new("Bright red").Color)
		eff.Rate = 50000
...
dmg(v)
	...
	sphere2(2,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Bright red"))
	sphere2(1,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Really red"))
	...
	for i = 0, 99 do
		...
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright red"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright red"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright red"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright red"))
...
function CalamitasL()
	...
	for i = 0, 49 do
		...
		poste = poste + 1
		sphere2(math.random(4,6),"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,1,5),-0.05,math.random(25,100)/25,-0.05,keptcolor)
		slash(math.random(50,100)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(poste/100,0.01,poste/100),poste/50,BrickColor.new("Really blue"))
		sphere2(8,"Add",tors.CFrame,vt(poste/1.5,poste/1.5,poste/1.5),0.01,0.01,0.01,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90 + rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180 + rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
	...
	game:GetService("Debris"):AddItem(efec2, 5)
	game:GetService("Debris"):AddItem(efec3, 5)
	ModeOfGlitch = 6000000002
	storehumanoidWS = 300
	hum.WalkSpeed = 300
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Skylar, Brutal Calamity (Lament)",BrickColor.new("Really blue").Color,BrickColor.new("Bright blue").Color,"Highway")
	newThemeCust("rbxassetid://2549532399",0,1,3)
	...
	shirt.ShirtTemplate = "rbxassetid://6721443380"
	pants.PantsTemplate = "rbxassetid://6721440897"
	wait(1.3)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Leave me alone!!!",MAINRUINCOLOR.Color,9)
	wait(2)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Once I'm done with you, Yharim is next.",MAINRUINCOLOR.Color,9)
	wait(2)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("He'll pay for this.",MAINRUINCOLOR.Color,9)
	wait(1.9)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("SO WILL YOU!!!",MAINRUINCOLOR.Color,9)
	wait(1.2)
	CFuncs["Sound"].Create("rbxassetid://763717897", char, 4, 1)
	CFuncs["Sound"].Create("rbxassetid://1192402877", char, 2.5, 0.75)
	CFuncs["Sound"].Create("rbxassetid://1664711478", char, 4, 0.95)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,BrickColor.new("Bright blue"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,keptcolor)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Really blue"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Bright blue"))
	sphere2(4,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,keptcolor)
	for i = 0, 99 do
		local dis = CreateParta(char,1,1,"Neon",MAINRUINCOLOR)
		dis.CFrame = root.CFrame*CFrame.new(math.random(-5,5),math.random(-5,5),math.random(-5,5))*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))
	...
	hum.WalkSpeed = storehumanoidWS
	for i = 0, 99 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,2500)/250,BrickColor.new("Really blue"))
	end
	for i = 0, 49 do
		local rsiz = math.random(150,450)
		sphere2(math.random(1,4),"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(15,1,15),-0.05,math.random(25,500)/25,-0.05,BrickColor.new("Bright blue"))
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))*CFrame.new(math.random(-350,350),math.random(-350,350),math.random(-350,350)),vt(1,1,1),-0.01,math.random(50,250)/10,-0.01,BrickColor.new("Bright blue"))
		sphereMK(math.random(1,2),math.random(2,4),"Add",x.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Really blue"),0)
	end
	coroutine.resume(coroutine.create(function()
		local eff = Instance.new("ParticleEmitter",x)
		eff.Texture = "rbxassetid://2273224484"
		eff.LightEmission = 1
		eff.Color = ColorSequence.new(BrickColor.new("Bright blue").Color)
		eff.Rate = 50000
		eff.Lifetime = NumberRange.new(3,8)
		eff.Size = NumberSequence.new({NumberSequenceKeypoint.new(0,120,0),NumberSequenceKeypoint.new(0.2,25,0),NumberSequenceKeypoint.new(1,0.1,0)})
		eff.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(0.2,0,0),NumberSequenceKeypoint.new(1,1,0)})
...
dmg(v)
	...
	sphere2(3,"Add",tors.CFrame,vt(1,1,1),10,10,10,keptcolor)
	sphere2(2,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Bright blue"))
	sphere2(1,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Really blue"))
	CameraEnshaking(8,10)
	for i = 0, 99 do
		swait()
		rotation = rotation + 5
		...
		rate = rate + 0.1
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.new(math.random(-350,350),0,math.random(-350,350)),vt(5,1,5),-0.05,math.random(50,250)/50,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright blue"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright blue"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright blue"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright blue"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
...
function CalamitasE()
	...
	for i = 0, 49 do
		...
		poste = poste + 1
		sphere2(math.random(4,6),"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,1,5),-0.05,math.random(25,100)/25,-0.05,keptcolor)
		slash(math.random(50,100)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(poste/100,0.01,poste/100),poste/50,BrickColor.new("Deep orange"))
		sphere2(8,"Add",tors.CFrame,vt(poste/1.5,poste/1.5,poste/1.5),0.01,0.01,0.01,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90 + rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180 + rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
	...
	game:GetService("Debris"):AddItem(efec2, 5)
	game:GetService("Debris"):AddItem(efec3, 5)
	ModeOfGlitch = 6000000003
	storehumanoidWS = 300
	hum.WalkSpeed = 300
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Skylar, Brutal Calamity (Epiphany)",BrickColor.new("Deep orange").Color,BrickColor.new("Bright orange").Color,"Highway")
	newThemeCust("rbxassetid://2457385004",0,1,3)
	MAINRUINCOLOR = BrickColor.new("Bright orange")
	keptcolor = MAINRUINCOLOR
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Deep orange"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = origtemplate
	pants.PantsTemplate = "rbxassetid://2967409832"
	wait(1.3)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("W-what if I'm in the wrong...",MAINRUINCOLOR.Color,9)
	wait(2)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("I cant be..Can I?",MAINRUINCOLOR.Color,9)
	wait(2)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Whatever, I still need finish you.",MAINRUINCOLOR.Color,9)
	wait(1.9)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Goodbye Fool!",MAINRUINCOLOR.Color,9)
	wait(1.2)
	CFuncs["Sound"].Create("rbxassetid://763717897", char, 4, 1)
	CFuncs["Sound"].Create("rbxassetid://1192402877", char, 2.5, 0.75)
	CFuncs["Sound"].Create("rbxassetid://1664711478", char, 4, 0.95)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,BrickColor.new("Bright orange"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,keptcolor)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Deep orange"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Bright orange"))
	sphere2(4,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,keptcolor)
	for i = 0, 99 do
		local dis = CreateParta(char,1,1,"Neon",MAINRUINCOLOR)
		dis.CFrame = root.CFrame*CFrame.new(math.random(-5,5),math.random(-5,5),math.random(-5,5))*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))
	...
	hum.WalkSpeed = storehumanoidWS
	for i = 0, 99 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,2500)/250,BrickColor.new("Deep orange"))
	end
	for i = 0, 49 do
		local rsiz = math.random(150,450)
		sphere2(math.random(1,4),"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(15,1,15),-0.05,math.random(25,500)/25,-0.05,BrickColor.new("Bright orange"))
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))*CFrame.new(math.random(-350,350),math.random(-350,350),math.random(-350,350)),vt(1,1,1),-0.01,math.random(50,250)/10,-0.01,BrickColor.new("Bright orange"))
		sphereMK(math.random(1,2),math.random(2,4),"Add",x.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Deep orange"),0)
	end
	coroutine.resume(coroutine.create(function()
		local eff = Instance.new("ParticleEmitter",x)
		eff.Texture = "rbxassetid://2273224484"
		eff.LightEmission = 1
		eff.Color = ColorSequence.new(BrickColor.new("Bright orange").Color)
		eff.Rate = 50000
		eff.Lifetime = NumberRange.new(3,8)
		eff.Size = NumberSequence.new({NumberSequenceKeypoint.new(0,120,0),NumberSequenceKeypoint.new(0.2,25,0),NumberSequenceKeypoint.new(1,0.1,0)})
		eff.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(0.2,0,0),NumberSequenceKeypoint.new(1,1,0)})
...
dmg(v)
	...
	sphere2(3,"Add",tors.CFrame,vt(1,1,1),10,10,10,keptcolor)
	sphere2(2,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Bright orange"))
	sphere2(1,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Deep orange"))
	CameraEnshaking(8,10)
	for i = 0, 99 do
		swait()
		rotation = rotation + 5
		...
		rate = rate + 0.1
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.new(math.random(-350,350),0,math.random(-350,350)),vt(5,1,5),-0.05,math.random(50,250)/50,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright orange"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright orange"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright orange"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Bright orange"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
...
function CalamitasA()
	...
	game:GetService("Debris"):AddItem(efec2, 5)
	game:GetService("Debris"):AddItem(efec3, 5)
	ModeOfGlitch = 6000000004
	storehumanoidWS = 300
	hum.WalkSpeed = 300
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Skylar, Brutal Calamity (Acceptance)",BrickColor.new("Really black").Color,BrickColor.new("Dark stone grey").Color,"Highway")
	newThemeCust("rbxassetid://2457387217",0,1,3)
	...
	shirt.ShirtTemplate = "rbxassetid://1088295747"
	pants.PantsTemplate = "rbxassetid://2457454624"
	wait(1.3)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("I'm sorry...",MAINRUINCOLOR.Color,9)
	wait(2)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Mother, Father I'm sorry.",MAINRUINCOLOR.Color,9)
	wait(2)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("I'll see you soon, you too Brothers.",MAINRUINCOLOR.Color,9)
	wait(1.9)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("I'm ready, I'm accepting my fate. Finish it.",MAINRUINCOLOR.Color,9)
	wait(1.2)
	CFuncs["Sound"].Create("rbxassetid://763717897", char, 4, 1)
	CFuncs["Sound"].Create("rbxassetid://1192402877", char, 2.5, 0.75)
	CFuncs["Sound"].Create("rbxassetid://1664711478", char, 4, 0.95)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,BrickColor.new("Dark stone grey"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,keptcolor)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Really black"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Dark stone grey"))
	sphere2(4,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,keptcolor)
	for i = 0, 99 do
		local dis = CreateParta(char,1,1,"Neon",MAINRUINCOLOR)
		dis.CFrame = root.CFrame*CFrame.new(math.random(-5,5),math.random(-5,5),math.random(-5,5))*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))
	...
	hum.WalkSpeed = storehumanoidWS
	for i = 0, 99 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,2500)/250,BrickColor.new("Really black"))
	end
	for i = 0, 49 do
		local rsiz = math.random(150,450)
		sphere2(math.random(1,4),"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(15,1,15),-0.05,math.random(25,500)/25,-0.05,BrickColor.new("Dark stone grey"))
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))*CFrame.new(math.random(-350,350),math.random(-350,350),math.random(-350,350)),vt(1,1,1),-0.01,math.random(50,250)/10,-0.01,BrickColor.new("Dark stone grey"))
		sphereMK(math.random(1,2),math.random(2,4),"Add",x.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Really black"),0)
	end
	coroutine.resume(coroutine.create(function()
		local eff = Instance.new("ParticleEmitter",x)
		eff.Texture = "rbxassetid://2273224484"
		eff.LightEmission = 1
		eff.Color = ColorSequence.new(BrickColor.new("Dark stone grey").Color)
		eff.Rate = 50000
		eff.Lifetime = NumberRange.new(3,8)
		eff.Size = NumberSequence.new({NumberSequenceKeypoint.new(0,120,0),NumberSequenceKeypoint.new(0.2,25,0),NumberSequenceKeypoint.new(1,0.1,0)})
		eff.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(0.2,0,0),NumberSequenceKeypoint.new(1,1,0)})
...
dmg(v)
	...
	sphere2(3,"Add",tors.CFrame,vt(1,1,1),10,10,10,keptcolor)
	sphere2(2,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Dark stone grey"))
	...
	for i = 0, 99 do
		...
		rate = rate + 0.1
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.new(math.random(-350,350),0,math.random(-350,350)),vt(5,1,5),-0.05,math.random(50,250)/50,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Dark stone grey"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Dark stone grey"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Dark stone grey"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Dark stone grey"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
...
function UnknownA()
	...
	for i = 0, 49 do
		...
		poste = poste + 1
		sphere2(math.random(4,6),"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,1,5),-0.05,math.random(25,100)/25,-0.05,keptcolor)
		slash(math.random(50,100)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(poste/100,0.01,poste/100),poste/50,BrickColor.new("Hot pink"))
		sphere2(8,"Add",tors.CFrame,vt(poste/1.5,poste/1.5,poste/1.5),0.01,0.01,0.01,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90 + rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180 + rotation),0)*CFrame.new(0,upperpos,poste),vt(5,5,5),-0.05,-0.05,-0.05,keptcolor)
	...
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Skylar, The Loyalist",BrickColor.new("Hot pink").Color,BrickColor.new("Pink").Color,"Highway")
	newThemeCust("rbxassetid://7330781067",0,1,3)
	MAINRUINCOLOR = BrickColor.new("Pink")
	keptcolor = MAINRUINCOLOR
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Hot pink"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = "rbxassetid://6677086553"
	pants.PantsTemplate = "rbxassetid://6677072918"
	wait(1.1)
	CFuncs["Sound"].Create("rbxassetid://952180729", char, 9, 1)
	bosschatfunc("Did you miss me?",MAINRUINCOLOR.Color,9)
	wait(1.5)
	CFuncs["Sound"].Create("rbxassetid://952180637", char, 9, 1)
	bosschatfunc("Is that all you've got?",MAINRUINCOLOR.Color,9)
	wait(2)
	CFuncs["Sound"].Create("rbxassetid://952180266", char, 9, 1)
	bosschatfunc("You're making it too easy",MAINRUINCOLOR.Color,9)
	wait(2.2)
	CFuncs["Sound"].Create("rbxassetid://952180440", char, 9, 1)
	bosschatfunc("How dreadful",MAINRUINCOLOR.Color,9)
	wait(1.2)
	CFuncs["Sound"].Create("rbxassetid://763717897", char, 4, 1)
	CFuncs["Sound"].Create("rbxassetid://1192402877", char, 2.5, 0.75)
	CFuncs["Sound"].Create("rbxassetid://1664711478", char, 4, 0.95)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,BrickColor.new("Pink"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(15,0,15),5,0,5,keptcolor)
	sphere2(1,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Hot pink"))
	sphere2(2,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,BrickColor.new("Pink"))
	sphere2(4,"Add",x.CFrame*CFrame.new(0,0,0),vt(5,50000,5),1.5,1,1.5,keptcolor)
	for i = 0, 99 do
		local dis = CreateParta(char,1,1,"Neon",MAINRUINCOLOR)
		dis.CFrame = root.CFrame*CFrame.new(math.random(-5,5),math.random(-5,5),math.random(-5,5))*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))
	...
	hum.WalkSpeed = storehumanoidWS
	for i = 0, 99 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,2500)/250,BrickColor.new("Hot pink"))
	end
	for i = 0, 49 do
		local rsiz = math.random(150,450)
		sphere2(math.random(1,4),"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(15,1,15),-0.05,math.random(25,500)/25,-0.05,BrickColor.new("Pink"))
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))*CFrame.new(math.random(-350,350),math.random(-350,350),math.random(-350,350)),vt(1,1,1),-0.01,math.random(50,250)/10,-0.01,BrickColor.new("Pink"))
		sphereMK(math.random(1,2),math.random(2,4),"Add",x.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Hot pink"),0)
	end
	coroutine.resume(coroutine.create(function()
		local eff = Instance.new("ParticleEmitter",x)
		eff.Texture = "rbxassetid://2273224484"
...
dmg(v)
	...
	sphere2(3,"Add",tors.CFrame,vt(1,1,1),10,10,10,keptcolor)
	sphere2(2,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Pink"))
	sphere2(1,"Add",tors.CFrame,vt(1,1,1),10,10,10,BrickColor.new("Hot pink"))
	CameraEnshaking(8,10)
	for i = 0, 99 do
		swait()
		rotation = rotation + 5
		...
		rate = rate + 0.1
		sphere2(math.random(1,2),"Add",x.CFrame*CFrame.new(math.random(-350,350),0,math.random(-350,350)),vt(5,1,5),-0.05,math.random(50,250)/50,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Pink"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Pink"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Pink"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270+rotation),0)*CFrame.new(0,upperpos,poste),vt(5+upperpos/5,5+upperpos/5,5+upperpos/5),-0.05,-0.05,-0.05,BrickColor.new("Pink"))
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(90-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(180-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
		sphere2(8,"Add",x.CFrame*CFrame.Angles(0,math.rad(270-rotation),0)*CFrame.new(0,upperpos/2,poste*2),vt(5+upperpos/10,5+upperpos/10,5+upperpos/10),-0.05,-0.05,-0.05,keptcolor)
...
function DevourerOfGodsP2()
	attack = true
	hum.WalkSpeed = 0
	MAINRUINCOLOR = BrickColor.new("Bright blue")
	newThemeCust("rbxassetid://1504604335",0,1.01,1.5) --737063244,925278639
	local vel = Instance.new("BodyPosition", root)
	vel.P = 10000
	vel.D = 1000
	vel.maxForce = Vector3.new(50000000000, 10e10, 50000000000)
	...
	efec.Texture = "rbxassetid://2109052855"
	efec.LightEmission = 1
	efec.Color = ColorSequence.new(Color3.new(1,0.5,1))
	efec.Rate = 5
	efec.Lifetime = NumberRange.new(3)
	...
	local efec3 = efec:Clone()
	efec3.LightEmission = 1
	efec3.Color = ColorSequence.new(Color3.new(1,0.5,1))
	efec3.Texture = "rbxassetid://2273224484"
	efec3.Parent = root
	efec3.Rate = 10000
	efec3.Drag = 5
	...
	for i = 0, 40, 0.1 do
		...
		absval = absval + 0.01
		slash(math.random(50,100)/10,2,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(absval*2,0.01,absval*2),math.random(10,100)/1000,BrickColor.new("Bright blue"))
		slash(math.random(10,100)/10,2,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(absval/3,0.01,absval/3),math.random(50,100)/100,BrickColor.new("Pink"))
		for i = 0, 1 do
	...
	for i = 0, 9, 0.1 do
		...
		for i = 0, 4 do
			slash(math.random(10,50)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(absval/2,0.01,absval/2),math.random(50,5000)/100,BrickColor.new("Pink"))
		end
		RH.C0=clerp(RH.C0,cf(1,-0.05,-0.75)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-2.5),math.rad(0),math.rad(-30)),.1)
		LH.C0=clerp(LH.C0,cf(-1,-0.5,-0.25)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-2.5),math.rad(0),math.rad(30)),.1)
		RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1.5 + 0.1 * math.cos(sine / 28))*angles(math.rad(20 - 1 * math.cos(sine / 34)),math.rad(0),math.rad(0)),.1)
	...
	efec2:Destroy()
	efec3:Destroy()
	ModeOfGlitch = 5000000005
	storehumanoidWS = 200
	hum.WalkSpeed = 200
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Devourer Of Gods",Color3.new(1,0.5,1),Color3.new(0,0.5,1),"Highway")
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Pink"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = "rbxassetid://801887376"
	pants.PantsTemplate = "rbxassetid://1342248733"
	hum.WalkSpeed = 200
	attack = false
	wait(0.8)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("It's not over yet, Kid.",MAINRUINCOLOR.Color,9)
	wait(1.5)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Devourer Of Gods Has Awoken",MAINRUINCOLOR.Color,9)
end
...
function CeaselessVoid()
	...
	hum.WalkSpeed = 0
	MAINRUINCOLOR = BrickColor.new("Bright blue")
	newThemeCust("rbxassetid://2018331827",0,1.01,1.5) --737063244,925278639
	local vel = Instance.new("BodyPosition", root)
	vel.P = 10000
	vel.D = 1000
	vel.maxForce = Vector3.new(50000000000, 10e10, 50000000000)
	...
	efec2:Destroy()
	efec3:Destroy()
	ModeOfGlitch = 5000000002
	storehumanoidWS = 200
	hum.WalkSpeed = 200
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Ceaseless Void",Color3.new(1,0.5,1),Color3.new(0,0.5,1),"Highway")
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Pink"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = origtemplate
	pants.PantsTemplate = "rbxassetid://2890058612"
	hum.WalkSpeed = 200
	attack = false
	wait(0.5)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Ceaseless Void Has Awoken",MAINRUINCOLOR.Color,9)
end

function StormWeaver()
	attack = true
	hum.WalkSpeed = 0
	MAINRUINCOLOR = BrickColor.new("Bright blue")
	newThemeCust("rbxassetid://2018331827",0,1.01,1.5) --737063244,925278639
	...
	efec2:Destroy()
	efec3:Destroy()
	ModeOfGlitch = 5000000003
	storehumanoidWS = 200
	hum.WalkSpeed = 200
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Storm Weaver",Color3.new(1,0.5,1),Color3.new(0,0.5,1),"SciFi")
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Pink"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = origtemplate
	pants.PantsTemplate = "rbxassetid://1085297061"
	hum.WalkSpeed = 200
	attack = false
	wait(0.5)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Storm Weaver Has Awoken",MAINRUINCOLOR.Color,9)
end

function SignusEnvoyOfTheDevourer()
	attack = true
	local keptcolor = MAINRUINCOLOR
	hum.WalkSpeed = 0
	for i = 0, 5, 0.1 do
	...
	for i = 0, 24 do
		slash(math.random(10,50)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,500)/250,BrickColor.new("Pink"))
	end
	for i = 0, 49 do
		local rsiz = math.random(70,90)
		sphere2(math.random(1,4),"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,1,5),-0.005,math.random(25,100)/25,-0.005,MAINRUINCOLOR)
	...
	CFuncs["Sound"].Create("rbxassetid://847061203", char, 1,1)
	CFuncs["Sound"].Create("rbxassetid://543623779", root, 1.5,1)
	newTheme("rbxassetid://2018331827",0,1,2)
	ModeOfGlitch = 5000000004
	MAINRUINCOLOR = BrickColor.new("Bright blue")
	for i = 0, 1, 0.2 do
		swait()
		RH.C0=clerp(RH.C0,cf(1,-1.05,0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(7),math.rad(0),math.rad(-16)),.8)
	...
	CameraEnshaking(2,11)
	sphere2(2,"Add",root.CFrame,vt(5,5,5),0.75,0.75,0.75,BrickColor.new("Bright blue"))
	sphere2(2,"Add",root.CFrame,vt(5,5,5),1,1,1,BrickColor.new("Bright blue"))
	sphere2(3,"Add",root.CFrame,vt(5,5,5),1.25,1.25,1.25,MAINRUINCOLOR)
	sphere2(3,"Add",root.CFrame,vt(5,5,5),1.5,1.5,1.5,MAINRUINCOLOR)
	sphere2(1,"Add",root.CFrame,vt(5,10000,5),0.5,0.5,0.5,BrickColor.new("Bright blue"))
	sphere2(2,"Add",root.CFrame,vt(5,10000,5),1,1,1,MAINRUINCOLOR)
	CFuncs["Sound"].Create("rbxassetid://1368637781", char, 2,1)
	CFuncs["Sound"].Create("rbxassetid://763717897", char, 3, 1.125)
	CFuncs["Sound"].Create("rbxassetid://1192402877", char, 3, 0.75)
	for i = 0, 49 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,500)/250,BrickColor.new("Pink"))
	end
	for i = 0, 49 do
		local rsiz = math.random(70,90)
		sphere2(math.random(1,4),"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,1,5),-0.005,math.random(50,200)/25,-0.005,MAINRUINCOLOR)
		sphereMK(math.random(1,2),math.random(1,3),"Add",root.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Bright blue"),0)
	end
	CFuncs["Sound"].Create("rbxassetid://847061203", char, 1,1)
	for i = 0, 1, 0.2 do
		swait()
	...
	CameraEnshaking(9,14)
	sphere2(4,"Add",root.CFrame,vt(5,5,5),1,1,1,BrickColor.new("Bright blue"))
	sphere2(4,"Add",root.CFrame,vt(5,5,5),2,2,2,BrickColor.new("Bright blue"))
	sphere2(9,"Add",root.CFrame,vt(5,5,5),3,3,3,MAINRUINCOLOR)
	sphere2(9,"Add",root.CFrame,vt(5,5,5),4,4,4,MAINRUINCOLOR)
	CFuncs["Sound"].Create("rbxassetid://847061203", char, 3,0.5)
	CFuncs["Sound"].Create("rbxassetid://763717897", char, 5, 0.75)
	CFuncs["Sound"].Create("rbxassetid://1192402877", char, 6, 0.5)
	CFuncs["Sound"].Create("rbxassetid://1664711478", char, 5, 1)
	sphere2(1,"Add",root.CFrame,vt(5,5,5),2,2,2,BrickColor.new("Bright blue"))
	sphere2(1,"Add",root.CFrame,vt(5,5,5),3,3,3,BrickColor.new("Bright blue"))
	sphere2(1,"Add",root.CFrame,vt(5,5,5),4,4,4,BrickColor.new("Bright blue"))
	sphere2(1,"Add",root.CFrame,vt(5,10000,5),2.5,2.5,2.5,BrickColor.new("Bright blue"))
	sphere2(2,"Add",root.CFrame,vt(5,10000,5),3.5,3.5,3.5,MAINRUINCOLOR)
	sphere2(1,"Add",root.CFrame,vt(5,5,5),8,8,8,BrickColor.new("Bright blue"))
	sphere2(2,"Add",root.CFrame,vt(5,5,5),14,14,14,MAINRUINCOLOR)
	sphere2(3,"Add",root.CFrame,vt(5,5,5),20,20,20,MAINRUINCOLOR)
	for i = 0, 99 do
		slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(250,2500)/250,BrickColor.new("Pink"))
	end
	for i = 0, 99 do
		local rsiz = math.random(150,450)
		sphere2(math.random(1,4),"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(15,1,15),-0.05,math.random(25,500)/25,-0.05,BrickColor.new("Bright blue"))
		sphere2(math.random(1,2),"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))*CFrame.new(math.random(-350,350),math.random(-350,350),math.random(-350,350)),vt(1,1,1),-0.01,math.random(50,250)/10,-0.01,MAINRUINCOLOR)
		sphereMK(math.random(1,2),math.random(4,6),"Add",root.CFrame*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,BrickColor.new("Bright blue"),0)
	end
	coroutine.resume(coroutine.create(function()
		local eff = Instance.new("ParticleEmitter",root)
		eff.Texture = "rbxassetid://749327003"
	...
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Signus, Envoy Of The Devourer",Color3.new(1,0.5,1),Color3.new(0,0.5,1),"Antique")
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Pink"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = origtemplate
	pants.PantsTemplate = "rbxassetid://2949764456"
	for i = 0, 2, 0.1 do
		swait()
		sphere2(math.random(1,2),"Add",root.CFrame*CFrame.new(math.random(-350,350),0,math.random(-350,350)),vt(5,1,5),-0.05,math.random(50,250)/50,-0.05,MAINRUINCOLOR)
		RH.C0=clerp(RH.C0,cf(1,-1.05,0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(7),math.rad(0),math.rad(-16)),.8)
	...
	wait(0.5)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
	bosschatfunc("Signus, Envoy Of The Devourer Has Awoken",MAINRUINCOLOR.Color,9)
end

function DevourerOfGodsP1()
	attack = true
	hum.WalkSpeed = 0
	MAINRUINCOLOR = BrickColor.new("Bright blue")
	newThemeCust("rbxassetid://1359036559",0,1.01,1.5) --737063244,925278639
	local vel = Instance.new("BodyPosition", root)
	vel.P = 10000
	vel.D = 1000
	vel.maxForce = Vector3.new(50000000000, 10e10, 50000000000)
	...
	efec2:Destroy()
	efec3:Destroy()
	ModeOfGlitch = 5000000001
	storehumanoidWS = 200
	hum.WalkSpeed = 200
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Devourer Of Gods",Color3.new(1,0.5,1),Color3.new(0,0.5,1),"Antique")
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Pink"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = "rbxassetid://399789858"
	pants.PantsTemplate = "rbxassetid://399768755"
	hum.WalkSpeed = 200
	attack = false
	wait(0.5)
	CFuncs["Sound"].Create("rbxassetid://0", char, 9, 1)
...
function SolarSystem()
	...
	hum.WalkSpeed = 0
	MAINRUINCOLOR = BrickColor.new("Bright orange")
	newThemeCust("rbxassetid://4313028959",0,1.01,1.5) --737063244,925278639
	local vel = Instance.new("BodyPosition", root)
	vel.P = 10000
	vel.D = 1000
	vel.maxForce = Vector3.new(50000000000, 10e10, 50000000000)
	...
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Solar Conqueror",Color3.new(1,0.75,0),Color3.new(1,0.35,0),"Antique")
	RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = "rbxassetid://5180002747"
	pants.PantsTemplate = "rbxassetid://5180000750"
	hum.WalkSpeed = 200
	attack = false
end
...
function ascendAzure()
	attack = true
	hum.WalkSpeed = 0
	newThemeCust("rbxassetid://4607682464",0,1,1.5)
	...
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Ascended Converted By Pendulum Premium",BrickColor.new("Carnation pink").Color,BrickColor.new("Pink").Color,"Antique")
	RecolorThing(MAINRUINCOLOR,BrickColor.new("Carnation pink"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR)
	shirt.ShirtTemplate = "rbxassetid://2194635207"
	pants.PantsTemplate = "rbxassetid://2530752725"
	attack = false
end
...
function BeamOfDeath()
	...
	elseif radm == 2 then
		bosschatfunc("SPACIAL QUAKE!!",MAINRUINCOLOR.Color,1)
	elseif radm == 3 then
...
function BrimflareBeam()
	...
	CFuncs["Sound"].Create("rbxassetid://0", char, 5, 1,0,10,0.10,0.25,1)
	local radm = math.random(1,3)
	if radm == 1 then
		bosschatfunc("YAHHHH!!!",MAINRUINCOLOR.Color,1)
	elseif radm == 2 then
		bosschatfunc("HYAGH!!!",MAINRUINCOLOR.Color,1)
	elseif radm == 3 then
...
function GoddessBeam()
	...
	CFuncs["Sound"].Create("rbxassetid://1155326234", char, 5, 1,0,10,0.10,0.25,1)
	local radm = math.random(1,3)
	if radm == 1 then
		bosschatfunc("YAHHHH!!!",MAINRUINCOLOR.Color,1)
	elseif radm == 2 then
...
function ChaosGroundStrike()
	...
	CFuncs["EchoSound"].Create("rbxassetid://1595826525", char, 4, 1,0,10,0.15,0.5,1)
	bosschatfunc("HAHAHA!",MAINRUINCOLOR.Color,1.8)
	bosschatfunc("HAHAHA!",MAINRUINCOLOR.Color,1.9)
	bosschatfunc("HAHAHA!",MAINRUINCOLOR.Color,2)
	for i = 0, 2, 0.1 do
		swait()
...
function Starfall()
	attack = true
	hum.WalkSpeed = 0
	CFuncs["Sound"].Create("rbxassetid://401604539", root, 5, 1)
	CFuncs["Sound"].Create("rbxassetid://1368598393", char, 2.5, 0.5)
	CFuncs["Sound"].Create("rbxassetid://1368598393", root, 10, 0.5)
	CFuncs["EchoSound"].Create("rbxassetid://401604595", char, 4, 1,0,10,0.15,0.5,1)
	bosschatfunc("STARFALL!",MAINRUINCOLOR.Color,1.8)
	bosschatfunc("STARFALL!",MAINRUINCOLOR.Color,1.9)
	bosschatfunc("STARFALL!",MAINRUINCOLOR.Color,2)
	for i = 0, 5, 0.1 do
		swait()
...
function StarfallEX()
	attack = true
	hum.WalkSpeed = 0
	CFuncs["Sound"].Create("rbxassetid://401604539", root, 5, 0.7)
	CFuncs["Sound"].Create("rbxassetid://1368598393", char, 2.5, 0.5)
	CFuncs["Sound"].Create("rbxassetid://1368598393", root, 10, 0.5)
	CFuncs["EchoSound"].Create("rbxassetid://401604595", char, 4, 1,0,10,0.15,0.5,1)
	bosschatfunc("STARFALL!",MAINRUINCOLOR.Color,1.8)
...
function THE_TRUE_POWER_OF_VIOLENCE()
	attack = true
	hum.WalkSpeed = 0
	bosschatfunc("DREAD IT, RUN FROM IT...",MAINRUINCOLOR.Color,4)
	for i = 0, 10, 0.1 do
		swait()
		PixelBlockNeg(1,math.random(1,2),"Add",sorb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.02,MAINRUINCOLOR,0)
	...
	bosschatfunc("DESTINY STILL ARRIVES!",MAINRUINCOLOR.Color,2)
...
function ViolentRing()
	...
	bosschatfunc("SHOULD OF I TAKEN IT EASIER?!",MAINRUINCOLOR.Color,0.7)
...
function CollapseOfTheUniverse()
	attack = true
	local speedearn = 0
	hum.WalkSpeed = 0
	...
	bosschatfunc("Universal..",MAINRUINCOLOR.Color,1)
...
function starscatter()
	...
	local lookv = 2.5
	local power = 5
	sphere(1,"Add",root.CFrame,vt(1,100000,1),0.5,BrickColor.new("Pink"))
	sphere(1,"Add",root.CFrame,vt(1,1,1),0.75,BrickColor.new("Bright blue"))
	for i = 0, 9 do
		sphereMK(1,1.5,"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),10,10,45,-0.1,BrickColor.new("Pink"),0)
	end
	CFuncs["Sound"].Create("rbxassetid://180204650", char, 2.5, 0.6)
	CFuncs["Sound"].Create("rbxassetid://233856079", char, 1, 0.5)
	CFuncs["Sound"].Create("rbxassetid://1208650519", char, 2.5, 1)
	...
	coroutine.resume(coroutine.create(function()
		for i = 0, 24 do
			...
			rem3.CFrame = rem.CFrame*CFrame.Angles(0,math.rad(180),0)
			rem4.CFrame = rem.CFrame*CFrame.Angles(0,math.rad(270),0)
			orb_spawn_norm(rem.CFrame + rem.CFrame.lookVector*lookv,3,BrickColor.new("Pink"),power,25,75,10,power/5,7.5)
			orb_spawn_norm(rem2.CFrame + rem2.CFrame.lookVector*lookv,3,BrickColor.new("Bright blue"),power,25,75,10,power/5,7.5)
			orb_spawn_norm(rem3.CFrame + rem3.CFrame.lookVector*lookv,3,BrickColor.new("Pink"),power,25,75,10,power/5,7.5)
...
function normalmog()
	...
	ModeOfGlitch = 1
	storehumanoidWS = 16
	newTheme("rbxassetid://2532792635",48.6,1,1.25)
	RecolorTextAndRename("Converted By Pendulum Premium",Color3.new(1,0,1),Color3.new(1,0.5,1),"Fantasy")
	...
	if targetted ~= nil then
		...
		for i = 0,4,0.1 do
			...
			coroutine.resume(coroutine.create(function()
				...
				for i = 0, 2 do
					slash(5,5,true,"Round","Add","Out",targetted.Head.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(50,350)/250,BrickColor.new("Hot pink"))
				end
		...
		for i = 0, 49 do
			...
			slash(math.random(10,30)/15,5,true,"Round","Add","Out",targetted.Head.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(40,500)/250,BrickColor.new("Pink"))
		end
...
function EndGROUND()
	...
	sphere2(5,"Add",root.CFrame*CFrame.new(0,-3,0),vt(10,1,10),2,0.01,2,MAINRUINCOLOR,MAINRUINCOLOR.Color)
	for i = 0, 24 do
		slash(math.random(15,50)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-5,5)),math.rad(math.random(-5,5))),vt(0.01,0.01,0.01),math.random(200,500)/250,BrickColor.new("Hot pink"))
	end
	local rrot = 0
	local xam = 1
	coroutine.resume(coroutine.create(function()
		for i = 0, 14 do
			...
			coroutine.resume(coroutine.create(function()
				...
				for i = 0, 9 do
					slash(math.random(15,50)/10,5,true,"Round","Add","Out",xa.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(0.01*bonus,0.01,0.01*bonus),math.random(50,125)/250*bonus,BrickColor.new("Hot pink"))
				end
				...
				sphere2(4,"Add",xa.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(30*bonus,1,30*bonus),0.05*bonus,1.5*bonus,0.05*bonus,BrickColor.new("Hot pink"),Color3.new(0,0,0))
				game:GetService("Debris"):AddItem(xa, 5)
				coroutine.resume(coroutine.create(function()
					for i = 0, 19 do
						swait()
...
function smiter()
	...
	if targetted ~= nil then
		...
		local radm = math.random(1,3)
		if radm == 1 then
			bosschatfunc("PARTICLE CANNON ACTIVAVTED!",MAINRUINCOLOR.Color,1)
		elseif radm == 2 then
			bosschatfunc("DEATH FROM ABOVE!!",MAINRUINCOLOR.Color,1)
		elseif radm == 3 then
		...
		coroutine.resume(coroutine.create(function()
			...
			coroutine.resume(coroutine.create(function()
				...
				eff.Texture = "rbxassetid://2273224484"
				eff.LightEmission = 1
				eff.Color = ColorSequence.new(Color3.new(0,1,0))
				eff.Rate = 500000
				eff.Lifetime = NumberRange.new(0.5,2)
				eff.Size = NumberSequence.new({NumberSequenceKeypoint.new(0,20,0),NumberSequenceKeypoint.new(0.2,2,0),NumberSequenceKeypoint.new(0.8,2,0),NumberSequenceKeypoint.new(1,0,0)})
				eff.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(0.1,0,0),NumberSequenceKeypoint.new(0.8,0,0),NumberSequenceKeypoint.new(1,1,0)})
...
function GalaxyDisk()
	...
	for i = 0, 14 do
		PixelBlock(1,math.random(1,3),"Add",larm.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.02,BrickColor.new("Pink"),0)
	end
	for i = 0,2,0.1 do
		swait()
		sphere2(8,"Add",larm.CFrame*CFrame.new(0,-2,0)*CFrame.Angles(math.rad(90),0,0),vt(2.25,0.1,2.25),0.01,0.01,0.01,keptcolor,keptcolor.Color)
	...
	local rot = 15
	for i = 0, 2 do
		local dis = CreateParta(char,0.5,1,"Neon",BrickColor.new("Bright blue"))
		CFuncs["EchoSound"].Create("rbxassetid://763718160", dis, 3, 1.1,0,10,0.15,0.5,1)
		dis.CFrame = root.CFrame*CFrame.new(0,2,-3)
		CreateMesh(dis,"Sphere",10,1,10)
		local at1 = Instance.new("Attachment",dis)
		...
		coroutine.resume(coroutine.create(function()
			dis.Touched:connect(function(hit) 
				if hitted == false and hit.Parent ~= char then
					...
					for i = 0, 19 do
						PixelBlock(1,math.random(5,20),"Add",dis.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),4,4,4,0.08,BrickColor.new("Pink"),0)
					end
					coroutine.resume(coroutine.create(function()
						for i = 0, 19 do
							swait()
...
function ChaosBegone()
	...
	CFuncs["Sound"].Create("rbxassetid://1368598393", char, 2.5, 0.5)
	CFuncs["Sound"].Create("rbxassetid://1368598393", root, 10, 0.5)
	CFuncs["EchoSound"].Create("rbxassetid://142684400", char, 4, 1,0,10,0.15,0.5,1)
	bosschatfunc("Omae wa mou Shindeiru",MAINRUINCOLOR.Color,1.8)
	bosschatfunc("Omae wa mou Shindeiru",MAINRUINCOLOR.Color,1.9)
	bosschatfunc("Omae wa mou Shindeiru",MAINRUINCOLOR.Color,2)
	for i = 0, 10, 0.1 do
		swait()
		speedearn = speedearn + 0.1
		sphereMK(1+speedearn,speedearn,"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),5,5,10*speedearn,-0.05,MAINRUINCOLOR,0)
...
function FallenOrbs()
	...
	elseif radm == 3 then
		bosschatfunc("Nanoswarm!",MAINRUINCOLOR.Color,1)
	end
	coroutine.resume(coroutine.create(function()
		for i = 0, 29 do
			swait(2)
...
function FallenDEMISE()
	...
	hum.WalkSpeed = 0
	local keptcolor = MAINRUINCOLOR
	bosschatfunc("FACTORY RESETTING EARTH...",MAINRUINCOLOR.Color,3)
	...
	for i = 0, 15, 0.1 do
		...
		slash(math.random(30,150)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(1,0.01,1),math.random(100,500)/250,BrickColor.new("Really black"))
		slash(math.random(30,150)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(1,0.01,1),math.random(100,500)/250,BrickColor.new("Royal purple"))
		RH.C0=clerp(RH.C0,cf(1,-0.35,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-1),math.rad(0),math.rad(-35)),.1)
		LH.C0=clerp(LH.C0,cf(-1,-0.45,-0.5)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-1),math.rad(0),math.rad(35)),.1)
		RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,0)*angles(math.rad(5),math.rad(0),math.rad(0)),.1)
		Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(55),math.rad(0),math.rad(0)),.1)
	...
	for i = 0, 30, 0.1 do
		...
		sphere2(2,"Add",root.CFrame*CFrame.new(math.random(-2000,2000),math.random(-2000,2000),math.random(-2000,2000)),vt(0,0,0),5,5,5,BrickColor.new("Really black"))
		sphere2(2,"Add",root.CFrame*CFrame.new(math.random(-2000,2000),math.random(-2000,2000),math.random(-2000,2000)),vt(0,0,0),5,5,5,BrickColor.new("Royal purple"))
		slash(math.random(50,100)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,0.01,5),math.random(500,5000)/250,BrickColor.new("Really black"))
		slash(math.random(50,100)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,0.01,5),math.random(500,5000)/250,BrickColor.new("Royal purple"))
		for i = 0, 2 do
...
mouse.KeyDown:connect(function(k)
	if k == "q" and attack == false and ModeOfGlitch ~= 1 then
		...
		rainbowmode = false
		chaosmode = false
		newTheme("rbxassetid://2717554604",48.6,1,1.25)
		RecolorTextAndRename("Converted By Pendulum Premium",Color3.new(1,0.5,1),Color3.new(1,0,1),"Fantasy")
		MAINRUINCOLOR = BrickColor.new("Pink")
		RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,false)
		shirt.ShirtTemplate = "rbxassetid://1311228890"
		pants.PantsTemplate = "rbxassetid://1311226169"
	end
	if k == "e" and attack == false and ModeOfGlitch ~= 2 then
		...
		newTheme("rbxassetid://1273909636",0,1,1.25)
		...
		shirt.ShirtTemplate = "rbxassetid://282414534"
		pants.PantsTemplate = "rbxassetid://279698042"
	end
	if k == "r" and attack == false and ModeOfGlitch ~= 3 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("TOXIC",Color3.new(0,0,0),Color3.new(0.35,0,1),"Antique")
		newTheme("rbxassetid://7867901736",0,0.98,5)
		MAINRUINCOLOR = BrickColor.new("Royal purple")
		RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
		shirt.ShirtTemplate = origtemplate
		pants.PantsTemplate = panttemplate
	end
	if k == "t" and attack == false and ModeOfGlitch ~= 4 then
		...
		newTheme("rbxassetid://2784904276",0.1,1.01,3)
		MAINRUINCOLOR = BrickColor.new("Black")
		RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
		shirt.ShirtTemplate = origtemplate
		pants.PantsTemplate = "rbxassetid://1546518872"
	end
	if k == "y" and attack == false and ModeOfGlitch ~= 5 then
		...
		RecolorTextAndRename("NEPTUNE",BrickColor.new("Royal purple").Color,BrickColor.new("Bright blue").Color,"SciFi")
		newTheme("rbxassetid://1873219898",0,1,1.5)
		MAINRUINCOLOR = BrickColor.new("Royal purple")
		...
		shirt.ShirtTemplate = "rbxassetid://1139412661"
		pants.PantsTemplate = "rbxassetid://1139414350"
	end
	if k == "u" and attack == false and ModeOfGlitch ~= 6 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("FALLEN",Color3.new(0,0,0),Color3.new(0.709804, 0.709804, 0.709804),"Fantasy")
		newTheme("rbxassetid://2071274388",0,1,2.25)
		MAINRUINCOLOR = BrickColor.new("Black metallic")
		...
		shirt.ShirtTemplate = "rbxassetid://2481551922"
		pants.PantsTemplate = "rbxassetid://2481555935"
	end
	if k == "f" and attack == false and ModeOfGlitch ~= 8 then
		...
		newTheme("rbxassetid://1143394056",0,1,2)
		MAINRUINCOLOR = BrickColor.new("Alder")
		RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
		shirt.ShirtTemplate = "rbxassetid://1136801260"
		pants.PantsTemplate = "rbxassetid://1136800193"
	end
	if k == "g" and attack == false and ModeOfGlitch ~= 9 then
		...
		newTheme("rbxassetid://1276814239",0,1.01,1.25)
		...
		shirt.ShirtTemplate = origtemplate
		pants.PantsTemplate = "rbxassetid://558359012"
	end
	if k == "h" and attack == false and ModeOfGlitch ~= 5555 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("Miku Izayoi",Color3.new(1,1,0.4),BrickColor.new("Converted By Pendulum Premium violet").Color,"Arcade")
		newTheme("rbxassetid://7092435374",0,1,3)
		MAINRUINCOLOR = BrickColor.new("Converted By Pendulum Premium yellow")
		RecolorThing(MAINRUINCOLOR,BrickColor.new("Converted By Pendulum Premium violet"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
		shirt.ShirtTemplate = "rbxassetid://363672071"
		pants.PantsTemplate = "rbxassetid://526658829"
	end
	if k == "b" and attack == false and ModeOfGlitch == 8 and ModeOfGlitch ~= 8889 then
		ModeOfGlitch = 8889
		storehumanoidWS = 180
		hum.WalkSpeed = 180
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("Relaxed",Color3.new(0.447059, 0.741176, 1),BrickColor.new("Lilac").Color,"Cartoon")
		newTheme("rbxassetid://4649997591",0,1,6)
		...
		shirt.ShirtTemplate = "rbxassetid://1398776950"
		pants.PantsTemplate = "rbxassetid://1398776319"
	end
	if k == "n" and attack == false and ModeOfGlitch == 1 and ModeOfGlitch ~= 55469696922 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("Tohka Yatogami",BrickColor.new("Royal purple").Color,BrickColor.new("Pink").Color,"Fantasy")
		newTheme("rbxassetid://1738990672",0,1,2)
		MAINRUINCOLOR = BrickColor.new("Royal purple")
		...
		shirt.ShirtTemplate = "rbxassetid://487346379"
		pants.PantsTemplate = "rbxassetid://487318795"
	end
	if k == "n" and attack == false and ModeOfGlitch == 2 and ModeOfGlitch ~= 4367677813 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("Nightstalker",Color3.new(0.75,0,1),BrickColor.new("Royal purple").Color,"Arcade")
		newTheme("rbxassetid://298493316",0,1.01,1.25)
		MAINRUINCOLOR = BrickColor.new("Royal purple")
		RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
		shirt.ShirtTemplate = "rbxassetid://2194635207"
		pants.PantsTemplate = "rbxassetid://2194606857"
	end
	if k == "n" and attack == false and ModeOfGlitch == 8 and ModeOfGlitch ~= 9999999921111 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("Pandora",BrickColor.new("White").Color,BrickColor.new("Sunrise").Color,"Fantasy")
		newTheme("rbxassetid://1382488262",0,1.01,3)
		MAINRUINCOLOR = BrickColor.new("Sunrise")
	...
	if k == "n" and attack == false and ModeOfGlitch == 4 and ModeOfGlitch ~= 999999999556 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("Lusamine",BrickColor.new("Daisy orange").Color,BrickColor.new("White").Color,"Code")
		newTheme("rbxassetid://587016961",0,1.02,1.25)
		MAINRUINCOLOR = BrickColor.new("Daisy orange")
		RecolorThing(MAINRUINCOLOR,BrickColor.new("White"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
		shirt.ShirtTemplate = "rbxassetid://2348049248"
		pants.PantsTemplate = "rbxassetid://2496509567"
	end
	if k == "n" and attack == false and ModeOfGlitch == 5 and ModeOfGlitch ~= 1264532489 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("DESTROYER",Color3.new(0,0,0),BrickColor.new("Royal purple").Color,"SciFi")
		newTheme("rbxassetid://171576840",0,1.01,1.25)
		MAINRUINCOLOR = BrickColor.new("Royal purple")
		RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
		shirt.ShirtTemplate = "rbxassetid://1630281264"
		pants.PantsTemplate = "rbxassetid://1630282710"
	end
	...
	if k == "m" and attack == false and ModeOfGlitch == 1 and ModeOfGlitch ~= 2000000000 then
		ascendAzure()
	elseif k == "m" and attack == false and ModeOfGlitch == 8889 and ModeOfGlitch ~= 5000000000 then
		SolarSystem()
	elseif k == "m" and attack == false and ModeOfGlitch == 3 and ModeOfGlitch ~= 5000000001  then
		DevourerOfGodsP1()
	elseif k == "n" and attack == false and ModeOfGlitch == 5000000001 and ModeOfGlitch ~= 5000000002  then
		CeaselessVoid()
	elseif k == "b" and attack == false and ModeOfGlitch == 5000000002 and ModeOfGlitch ~= 5000000003  then
		StormWeaver()
	elseif k == "k" and attack == false and ModeOfGlitch == 5000000003 and ModeOfGlitch ~= 5000000004  then
		SignusEnvoyOfTheDevourer()
	elseif k == "l" and attack == false and ModeOfGlitch == 5000000004 and ModeOfGlitch ~= 5000000005  then
		DevourerOfGodsP2()
	elseif k == "m" and attack == false and ModeOfGlitch == 9 and ModeOfGlitch ~= 6000000000  then
		UnknownA()
	elseif k == "n" and attack == false and ModeOfGlitch == 6000000000 and ModeOfGlitch ~= 6000000001   then
		CalamitasG()
	elseif k == "b" and attack == false and ModeOfGlitch == 6000000001 and ModeOfGlitch ~= 6000000002  then
		CalamitasL()
	elseif k == "k" and attack == false and ModeOfGlitch == 6000000002 and ModeOfGlitch ~= 6000000003  then
		CalamitasE()
	elseif k == "l" and attack == false and ModeOfGlitch == 6000000003 and ModeOfGlitch ~= 6000000004  then
		CalamitasA()
	end
	...
	elseif k == "x" and attack == false and ModeOfGlitch == 3 then
		scattercorrupt()
	elseif k == "z" and attack == false and ModeOfGlitch == 5000000001 then
		starscatter()
	elseif k == "z" and attack == false and ModeOfGlitch == 5000000005 then
		starscatter()
	elseif k == "z" and attack == false and ModeOfGlitch == 5000000002 then
		Nova()
	elseif k == "x" and attack == false and ModeOfGlitch == 5000000002 then
		GalaxyDisk()
	...
	elseif k == "z" and attack == false and ModeOfGlitch == 2000000000 then
		AzureVANISHMENT()
	elseif k == "x" and attack == false and ModeOfGlitch == 2000000000 then
		AZUREFINALE()
	elseif k == "v" and attack == false and ModeOfGlitch == 6000000000 then
		GODDESSFINALE()
	elseif k == "z" and attack == false and ModeOfGlitch == 6000000000 then
		SingularityVoid()
	elseif k == "c" and attack == false and ModeOfGlitch == 5000000002 then
		SingularityVoid()
	elseif k == "x" and attack == false and ModeOfGlitch == 6000000000 then
		GoddessBeam()
	elseif k == "x" and attack == false and ModeOfGlitch == 6000000001 then
		BrimflareBeam()
	elseif k == "x" and attack == false and ModeOfGlitch == 6000000002 then
		BrimflareBeam()
	elseif k == "x" and attack == false and ModeOfGlitch == 6000000003 then
		BrimflareBeam()
	elseif k == "b" and attack == false and ModeOfGlitch == 6000000000 then
		harmonytaunty()
	elseif k == "c" and attack == false and ModeOfGlitch == 6000000000 then
		GoddessJump()
	elseif k == "c" and attack == false and ModeOfGlitch == 6000000001 then
		CalamityJump()
	elseif k == "c" and attack == false and ModeOfGlitch == 6000000002 then
		CalamityJump()
	elseif k == "c" and attack == false and ModeOfGlitch == 6000000003 then
		CalamityJump()
	elseif k == "c" and attack == false and ModeOfGlitch == 6000000004 then
		CalamityJump()
	elseif k == "x" and attack == false and ModeOfGlitch == 5000000000 then
		SingularityVoid()
	elseif k == "z" and attack == false and ModeOfGlitch == 5000000000 then
		GalacticalBeams()
	...
	elseif k == "x" and attack == false and ModeOfGlitch == 8 then
		BanishingOrb()
	elseif k == "c" and attack == false and ModeOfGlitch == 8 then
	...
	elseif k == "z" and attack == false and ModeOfGlitch == 5555 then
		hugg()
	elseif k == "c" and attack == false and ModeOfGlitch == 5555 then
		shytaunty()
	elseif k == "x" and attack == false and ModeOfGlitch == 9 then
		smiter()
	elseif k == "z" and attack == false and ModeOfGlitch == 6000000004 then
		hugged()
	...
	elseif k == "z" and attack == false and ModeOfGlitch == 1264532489 then
		FallenOrbs()
	elseif k == "x" and attack == false and ModeOfGlitch == 1264532489 then
		CyberSlash()
	end
...
coroutine.resume(coroutine.create(function()
	while true do
		swait()
		if ModeOfGlitch == 6 or ModeOfGlitch == 8 or ModeOfGlitch == 9 or ModeOfGlitch == 8889 or ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813  or ModeOfGlitch == 999999999556 then
...
imgca.Image = "rbxassetid://521073910" --997291547,521073910,2312119891
...
while true do
	...
	kan.Parent = char
	kan:Resume()
	if ModeOfGlitch ~= 1264532489 and ModeOfGlitch ~= 55469696922 and ModeOfGlitch ~= 4367677813 and ModeOfGlitch ~= 999999999556 then
		imgca.ImageTransparency = 1
	elseif ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813 or ModeOfGlitch == 999999999556 then
	...
	coroutine.resume(coroutine.create(function()
		if ModeOfGlitch == 6 or ModeOfGlitch == 8 or ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813  or ModeOfGlitch == 999999999556 or ModeOfGlitch == 8889 or ModeOfGlitch == 777 then
			if hitfloor ~= nil then
				...
				if ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813 or ModeOfGlitch == 999999999556 then
	...
	if equipped==true or equipped==false then
		...
		elseif torvel<1 and hitfloor~=nil then
			...
			if attack==false then
				...
				elseif ModeOfGlitch == 1264532489 then
					...
					--RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 - 0.04 * math.sin(sine / 24), 0 + 0.04 * math.sin(sine / 12), 0 + 0.05 * math.cos(sine / 12)) * angles(math.rad(0 - 2.5 * math.sin(sine / 12)), math.rad(0 - 2.5 * math.sin(sine / 24)), math.rad(0)),.1)
					--Torso.Neck.C0=clerp(Torso.Neck.C0,necko*cf(0, 0, 0 + ((1.25) - 1.33)) * angles(math.rad(10 - 2.5 * math.sin(sine / 12)), math.rad(0), math.rad(-25)),.1)
					--RW.C0=clerp(RW.C0,cf(1.25, 0.5, 0.3) * angles(math.rad(-45), math.rad(0), math.rad(-45)) , .1)
					--LW.C0=clerp(LW.C0,cf(-1.25, 0.5, 0.3) * angles(math.rad(-40), math.rad(0), math.rad(45)) ,  .1)
					--RH.C0=clerp(RH.C0,cf(1*1 + 0.05 * math.cos(sine / 12), -1*1 - 0.05 * math.sin(sine / 12), -0.01) * angles(math.rad(0), math.rad(85), math.rad(0)) * angles(math.rad(-1), math.rad(0), math.rad(0)),.1)
					--LH.C0=clerp(LH.C0,cf(-1*1 + 0.05 * math.cos(sine / 12), -1*1 - 0.05 * math.sin(sine / 12), -0.01) * angles(math.rad(0), math.rad(-85), math.rad(0)) * angles(math.rad(-1), math.rad(0), math.rad(0)),.1)
				...
				elseif ModeOfGlitch == 55469696922 then
					...
					LW.C0=clerp(LW.C0,cf(-1,0.5 + 0.025 * math.cos(sine / 45),0.45)*angles(math.rad(-23 - 3 * math.cos(sine / 73)),math.rad(2 - 1 * math.cos(sine / 55)),math.rad(35 - 8 * math.cos(sine / 51))),.1)
				elseif ModeOfGlitch == 5000000003 then
					RH.C0=clerp(RH.C0,cf(1,-0.4,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(19 + 8 * math.cos(sine / 62)),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-20 - 3 * math.cos(sine / 34))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(3 - 1 * math.cos(sine / 55)),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(26 + 5 * math.cos(sine / 41))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0 + 0.02 * math.cos(sine / 32),1 + 0.15 * math.cos(sine / 32))*angles(math.rad(-13 - 2 * math.cos(sine / 32)),math.rad(3),math.rad(10 - 4 * math.cos(sine / 67))),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(23 - 8 * math.cos(sine / 37)),math.rad(-21 + 2 * math.cos(sine / 58)),math.rad(-10 + 2 * math.cos(sine / 53))),.1)
				...
				elseif ModeOfGlitch == 5000000004 then
					RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-1),math.rad(0),math.rad(-10 + 5 * math.cos(sine / 34))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-1.5),math.rad(0),math.rad(5 + 3 * math.cos(sine / 34))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1 + 0.1 * math.cos(sine / 28))*angles(math.rad(2 + 3 * math.cos(sine / 34)),math.rad(0),math.rad(34 - 3 * math.cos(sine / 54))),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(15 - 4 * math.cos(sine / 28)),math.rad(0 - 1 * math.cos(sine / 44)),math.rad(-34 + 3 * math.cos(sine / 54))),.1)
				...
				elseif ModeOfGlitch == 5000000002 then
					RH.C0=clerp(RH.C0,cf(1,-0.4,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-10 - 7 * math.cos(sine / 56))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(10 + 3 * math.cos(sine / 52))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0 + 0.02 * math.cos(sine / 32),1 + 0.15 * math.cos(sine / 32))*angles(math.rad(0 - 2 * math.cos(sine / 32)),math.rad(0),math.rad(0)),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(13 - 2 * math.cos(sine / 37)),math.rad(0 + 1 * math.cos(sine / 58)),math.rad(0 + 2 * math.cos(sine / 53))),.1)
					RW.C0=clerp(RW.C0,cf(1.5,0.5 + 0.025 * math.cos(sine / 45),0)*angles(math.rad(2 + 5 * math.cos(sine / 74)),math.rad(1 - 3 * math.cos(sine / 53)),math.rad(14 + 5 * math.cos(sine / 32))),.1)
					LW.C0=clerp(LW.C0,cf(-1.5,0.5 + 0.025 * math.cos(sine / 45),0)*angles(math.rad(5 - 3 * math.cos(sine / 73)),math.rad(2 - 1 * math.cos(sine / 55)),math.rad(-14 - 6 * math.cos(sine / 33))),.1)
				elseif ModeOfGlitch == 5000000005 then
					RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(2),math.rad(0),math.rad(-16 + 4 * math.cos(sine / 34))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1.5),math.rad(10),math.rad(11 + 2 * math.cos(sine / 34))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1 + 0.1 * math.cos(sine / 28))*angles(math.rad(-6 - 3 * math.cos(sine / 34)),math.rad(0),math.rad(-25 - 4 * math.cos(sine / 53))),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(10 - 1 * math.cos(sine / 28)),math.rad(0 + 10 * math.cos(sine / 79)),math.rad(25 + 4 * math.cos(sine / 53))),.1)
				...
				elseif ModeOfGlitch == 6000000001 then
					RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(2),math.rad(0),math.rad(-15 + 6 * math.cos(sine / 34))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1.5),math.rad(0),math.rad(7.5 - 4 * math.cos(sine / 47))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1 + 0.1 * math.cos(sine / 28))*angles(math.rad(0 - 3 * math.cos(sine / 34)),math.rad(0),math.rad(-1 + 4 * math.cos(sine / 62))),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(10 - 3 * math.cos(sine / 28)),math.rad(5 - 6 * math.cos(sine / 79)),math.rad(1 - 4 * math.cos(sine / 62))),.1)
					RW.C0=clerp(RW.C0,cf(0.85,0.5 + 0.01 * math.cos(sine / 28),-0.65)*angles(math.rad(38 + 2 * math.cos(sine / 33)),math.rad(0),math.rad(-95 - 3 * math.cos(sine / 28))),.1)
					LW.C0=clerp(LW.C0,cf(-0.85,0.5 + 0.01 * math.cos(sine / 28),-0.65)*angles(math.rad(45 - 3 * math.cos(sine / 37)),math.rad(0),math.rad(80 + 5 * math.cos(sine / 30))),.1)
				elseif ModeOfGlitch == 6000000002 then
					RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(2),math.rad(0),math.rad(-15 + 6 * math.cos(sine / 34))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1.5),math.rad(0),math.rad(7.5 - 4 * math.cos(sine / 47))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1 + 0.1 * math.cos(sine / 28))*angles(math.rad(0 - 3 * math.cos(sine / 34)),math.rad(0),math.rad(-1 + 4 * math.cos(sine / 62))),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(10 - 3 * math.cos(sine / 28)),math.rad(5 - 6 * math.cos(sine / 79)),math.rad(1 - 4 * math.cos(sine / 62))),.1)
					RW.C0=clerp(RW.C0,cf(0.85,0.5 + 0.01 * math.cos(sine / 28),-0.65)*angles(math.rad(38 + 2 * math.cos(sine / 33)),math.rad(0),math.rad(-95 - 3 * math.cos(sine / 28))),.1)
					LW.C0=clerp(LW.C0,cf(-0.85,0.5 + 0.01 * math.cos(sine / 28),-0.65)*angles(math.rad(45 - 3 * math.cos(sine / 37)),math.rad(0),math.rad(80 + 5 * math.cos(sine / 30))),.1)
				elseif ModeOfGlitch == 6000000003 then
					RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(2),math.rad(0),math.rad(-15 + 6 * math.cos(sine / 34))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1.5),math.rad(0),math.rad(7.5 - 4 * math.cos(sine / 47))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1 + 0.1 * math.cos(sine / 28))*angles(math.rad(0 - 3 * math.cos(sine / 34)),math.rad(0),math.rad(-1 + 4 * math.cos(sine / 62))),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(10 - 3 * math.cos(sine / 28)),math.rad(5 - 6 * math.cos(sine / 79)),math.rad(1 - 4 * math.cos(sine / 62))),.1)
					RW.C0=clerp(RW.C0,cf(0.85,0.5 + 0.01 * math.cos(sine / 28),-0.65)*angles(math.rad(38 + 2 * math.cos(sine / 33)),math.rad(0),math.rad(-95 - 3 * math.cos(sine / 28))),.1)
					LW.C0=clerp(LW.C0,cf(-0.85,0.5 + 0.01 * math.cos(sine / 28),-0.65)*angles(math.rad(45 - 3 * math.cos(sine / 37)),math.rad(0),math.rad(80 + 5 * math.cos(sine / 30))),.1)
				elseif ModeOfGlitch == 6000000004 then
					RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(2),math.rad(0),math.rad(-15 + 6 * math.cos(sine / 34))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1.5),math.rad(0),math.rad(7.5 - 4 * math.cos(sine / 47))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1 + 0.1 * math.cos(sine / 28))*angles(math.rad(0 - 3 * math.cos(sine / 34)),math.rad(0),math.rad(-1 + 4 * math.cos(sine / 62))),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(10 - 3 * math.cos(sine / 28)),math.rad(5 - 6 * math.cos(sine / 79)),math.rad(1 - 4 * math.cos(sine / 62))),.1)
					RW.C0=clerp(RW.C0,cf(0.85,0.5 + 0.01 * math.cos(sine / 28),-0.65)*angles(math.rad(38 + 2 * math.cos(sine / 33)),math.rad(0),math.rad(-95 - 3 * math.cos(sine / 28))),.1)
					LW.C0=clerp(LW.C0,cf(-0.85,0.5 + 0.01 * math.cos(sine / 28),-0.65)*angles(math.rad(45 - 3 * math.cos(sine / 37)),math.rad(0),math.rad(80 + 5 * math.cos(sine / 30))),.1)
				elseif ModeOfGlitch == 5000000001 then
					RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(2),math.rad(0),math.rad(-15 + 6 * math.cos(sine / 34))),.1)
					LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1.5),math.rad(0),math.rad(7.5 - 4 * math.cos(sine / 47))),.1)
					RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1 + 0.1 * math.cos(sine / 28))*angles(math.rad(0 - 3 * math.cos(sine / 34)),math.rad(0),math.rad(-1 + 4 * math.cos(sine / 62))),.1)
					Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(10 - 3 * math.cos(sine / 28)),math.rad(5 - 6 * math.cos(sine / 79)),math.rad(1 - 4 * math.cos(sine / 62))),.1)
		...
		elseif torvel>2 and torvel<22 and hitfloor~=nil and ModeOfGlitch ~= 9999999921111 then
			Anim="Walk"

			if attack==false or ModeOfGlitch ~= 9999999921111 then
		...
		elseif torvel>=22 and hitfloor~=nil   and ModeOfGlitch ~= 9999999921111 then
			Anim="Run"

			if attack==false or ModeOfGlitch ~= 9999999921111 then
				if ModeOfGlitch ~= 6 and ModeOfGlitch ~= 5555 and ModeOfGlitch ~= 8 and ModeOfGlitch ~= 1264532489 and ModeOfGlitch ~= 55469696922 and ModeOfGlitch ~= 4367677813 and ModeOfGlitch ~= 9999999921111 and ModeOfGlitch ~= 999999999556 and ModeOfGlitch ~= 8889 then
				...
				elseif ModeOfGlitch == 6 or ModeOfGlitch == 5555 or ModeOfGlitch == 8 or ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813  or ModeOfGlitch == 999999999556 or ModeOfGlitch == 8889  and ModeOfGlitch ~= 9999999921111 then
			...
			elseif ModeOfGlitch ~= 1000000000 and ModeOfGlitch ~= 2000000000 and ModeOfGlitch ~= 6000000000 and ModeOfGlitch ~= 5000000000 and ModeOfGlitch ~= 6000000001 and ModeOfGlitch ~= 6000000002 and ModeOfGlitch ~= 6000000003 and ModeOfGlitch ~= 6000000004 and ModeOfGlitch ~= 9999999921111 then
				RH.C0=clerp(RH.C0,cf(1,-1 - 0.15 * math.cos(sine / 3),0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(0),math.rad(0),math.rad(0 + 95 * math.cos(sine / 6))),.1)
				LH.C0=clerp(LH.C0,cf(-1,-1 - 0.15 * math.cos(sine / 3),0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(0),math.rad(0),math.rad(0 + 95 * math.cos(sine / 6))),.1)
				RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,-0.3,-0.05 + 0.15 * math.cos(sine / 3))*angles(math.rad(25 - 4 * math.cos(sine / 3)),math.rad(0 + root.RotVelocity.Y*1.5),math.rad(0 - root.RotVelocity.Y - 1 * math.cos(sine / 6))),.1)
				Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(-6 + 2 * math.cos(sine / 3)),math.rad(0 + root.RotVelocity.Y*1.5),math.rad(0 - hed.RotVelocity.Y*1.5 + 1 * math.cos(sine / 6))),.1)
			...
			elseif ModeOfGlitch == 1000000000 or ModeOfGlitch == 2000000000 or ModeOfGlitch == 6000000000 or ModeOfGlitch == 5000000000 or ModeOfGlitch == 6000000001 or ModeOfGlitch == 6000000002 or ModeOfGlitch == 6000000003 or ModeOfGlitch == 6000000004 then
				RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(1.5),math.rad(0),math.rad(-20 - 5 * math.cos(sine / 34))),.2)
				LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1),math.rad(0),math.rad(20 + 2 * math.cos(sine / 38))),.2)
				RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 - 0.15 * math.cos(sine / 47),-0.5,0.5 + 0.1 * math.cos(sine / 28))*angles(math.rad(70),math.rad(0 - root.RotVelocity.Y),math.rad(0 - root.RotVelocity.Y *4.5 + 3 * math.cos(sine / 47))),.2)
				Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(-17 - 5 * math.cos(sine / 52)),math.rad(0 - 3 * math.cos(sine / 37)),math.rad(0 + 2 * math.cos(sine / 78))),.2)
