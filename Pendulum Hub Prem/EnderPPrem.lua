-------------------HATS NEEDED------------------
-- https://www.roblox.com/catalog/6904794619/Void-Sword-Halo
...
---ENDER FOR PENDULUM HUB PREMIUM---
--reanim
game.Players:Chat("-re")
wait(0.5)
game.Players:Chat("-gh 4773932088,4932541287,6904794619,4773883146") --only for just grass when executed u will have the hat automatically
--Edit section
wait(0.5)
game.Players.LocalPlayer.Character:FindFirstChild("swordhalo").Name = "SWORDH1"
game.Players.LocalPlayer.Character:FindFirstChild("swordhalo").Name = "SWORDH2"
...
local L_3_ = function(L_6_arg1, L_7_arg2, L_8_arg3)
	local L_9_ = {
		AlignOrientation = Instance.new("AlignOrientation", L_6_arg1),
		AlignPosition = Instance.new("AlignPosition", L_6_arg1)
	}

	local L_10_ = {
		Attach0 = Instance.new("Attachment", L_6_arg1),
		Attach1 = Instance.new("Attachment", L_7_arg2)
	}
	local L_11_ = L_6_arg1:FindFirstChildOfClass('SpecialMesh')--This will get the first "SpecialMesh" it finds if it does not find any, then it will return nil
	if L_8_arg3 and L_11_ then --If Mesh is set to true and it finds a mesh it will destroy it
		L_11_:Destroy()
	end
	L_6_arg1:BreakJoints()
	L_9_.AlignOrientation.Attachment0 = L_10_.Attach0
	L_9_.AlignOrientation.Attachment1 = L_10_.Attach1
	L_9_.AlignOrientation.Responsiveness = math.huge
	L_9_.AlignOrientation.RigidityEnabled = true

	L_9_.AlignPosition.Attachment0 = L_10_.Attach0
	L_9_.AlignPosition.Attachment1 = L_10_.Attach1
	L_9_.AlignPosition.Responsiveness = math.huge
	L_9_.AlignPosition.RigidityEnabled = true
	L_9_.AlignPosition.MaxForce = 999999999
	spawn(function()
		while _G.loop do 
			local L_12_ = (L_6_arg1.Position - (L_7_arg2.CFrame * L_10_.Attach0.CFrame:Inverse()).p).magnitude--magnitude can get the distance between two cframe or position
			if L_12_ >= 5 then 
				L_6_arg1.CFrame = L_7_arg2.CFrame * L_10_.Attach0.CFrame:Inverse()
			end
			L_6_arg1.Velocity = Vector3.new(0, 35, 0)
...
local L_4_ = L_3_(L_2_['Evil Aura'].Handle, L_2_['Right Arm'], false)
local L_5_ = L_2_['Right Arm'].CFrame * CFrame.new(0, -2, 0) * CFrame.Angles(math.rad(0), math.rad(60), 30)
L_4_[1].CFrame = L_5_:Inverse() * L_2_['Right Arm'].CFrame
spawn(function()
	L_2_.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
	_G.loop = false 
end)
...
local L_4_ = L_3_(L_2_['Divine Aura'].Handle, L_2_['Left Arm'], false)
local L_5_ = L_2_['Left Arm'].CFrame * CFrame.new(0, -2, 0) * CFrame.Angles(math.rad(0), math.rad(-60), 30)
L_4_[1].CFrame = L_5_:Inverse() * L_2_['Left Arm'].CFrame
spawn(function()
	L_2_.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
	_G.loop = false 
end)
...
local L_4_ = L_3_(L_2_['SWORDH1'].Handle, L_2_['Right Arm'], false)
local L_5_ = L_2_['Right Arm'].CFrame * CFrame.new(0, -2, 0) * CFrame.Angles(math.rad(0), math.rad(60), 30)
L_4_[1].CFrame = L_5_:Inverse() * L_2_['Right Arm'].CFrame
spawn(function()
	L_2_.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
...
local L_4_ = L_3_(L_2_['SWORDH2'].Handle, L_2_['Left Arm'], false)
local L_5_ = L_2_['Left Arm'].CFrame * CFrame.new(0, -2, 0) * CFrame.Angles(math.rad(0), math.rad(-60), 30)
L_4_[1].CFrame = L_5_:Inverse() * L_2_['Left Arm'].CFrame
spawn(function()
	L_2_.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
