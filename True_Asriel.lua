...
spawn(function()
wait(2)
game.Players:Chat(("Finally."))
wait(2)
game.Players:Chat(("I was so tired of being a flower."))
wait(3)
game.Players:Chat(("Howdy!"))
wait(3.5)
game.Players:Chat(("Chara, Are you there?"))
wait(3.6)
game.Players:Chat(("It's me, your best friend."))
wait(4)
local asset = getcustomasset or getsynasset
local parent = game.Workspace
local soundid = getcustomasset("hopes.mp3")
local volume = 1
local name = 'Hopes And Dreams'
local loop = true
...
audio.Looped = loop
audio.Playing = true
game.Players:Chat(("ASRIEL DREEMURR."))
end)
...
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Created by ???, Redone by Krafty", Text = "Enjoy True Asriel"})