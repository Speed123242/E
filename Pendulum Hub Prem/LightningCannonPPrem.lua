game.Players:Chat("-gh 7069717878,5316556735,8028454043")
wait()
...
local hat = Align(char['RainbowGodScythe'].Handle,char['Left Arm'],false)
local cf = char['Left Arm'].CFrame*CFrame.new(0,0,2.50)*CFrame.Angles(math.rad(120),math.rad(0),0)
...
local hat = Align(char['Rainbow Thunder Aura - Waist'].Handle,char['Left Arm'],false)
local cf = char['Left Arm'].CFrame*CFrame.new(0,0,2.50)*CFrame.Angles(math.rad(120),math.rad(0),0)
hat[1].CFrame = cf:Inverse() * char['Left Arm'].CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
...
Align(game.Players.LocalPlayer.Character["Cartoony Rainbow Rifle"].Handle, GUN.Base, Vector3.new(2, 0.75, 0), Vector3.new(180, 0, 90))
-- -gh 4623059912
