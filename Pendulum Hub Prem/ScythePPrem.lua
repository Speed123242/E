game.Players:Chat("-gh 6964082275,5628962502,4773932088")
...
local hat = Align(char['DualVoidScythe'].Handle,char['Right Arm'],false)
local cf = char['Right Arm'].CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(19),math.rad(0),0)
...
local hat = Align(char['BlackFlameAuraTop'].Handle,char['Right Arm'],false)
local cf = char['Right Arm'].CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(89),math.rad(0),0)
hat[1].CFrame = cf:Inverse() * char['Right Arm'].CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
...
local hat = Align(char['Evil Aura'].Handle,char['Right Arm'],false)
local cf = char['Right Arm'].CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(0),math.rad(90),0)
hat[1].CFrame = cf:Inverse() * char['Right Arm'].CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
...
bladeefo.Color = ColorSequence.new(BrickColor.new("Really black").Color)
bladeefo.Rate = 900
...
game:GetService("Workspace").non.Part.Name = "Part1"
game:GetService("Workspace").non.Part.Name = "Part2"
game:GetService("Workspace").non.Part.Name = "Part3"
game:GetService("Workspace").non.Part.Name = "Part4"
game:GetService("Workspace").non.Part.Name = "Part5"
game:GetService("Workspace").non.Part.Name = "Part6"

game:GetService("Workspace").non.Part1:Destroy()
game:GetService("Workspace").non.Part2:Destroy()
game:GetService("Workspace").non.Part3:Destroy()
game:GetService("Workspace").non.Part4:Destroy()
game:GetService("Workspace").non.Part5:Destroy()
game:GetService("Workspace").non.Part6:Destroy()
game:GetService("Workspace").non.Part:Destroy()
...
effecto.Color = ColorSequence.new(BrickColor.new("Really black").Color)
effecto.Rate = 10000
...
effector2.Color = ColorSequence.new(BrickColor.new("Really black").Color)
...
for i = 0, 29 do
  ...
  lba.Parent = lb
   lba.Material = "Neon"
    lba.BrickColor = BrickColor.new("Really black")
...
seen:Play()
  ...
  boim.Parent = las
   boim.Material = "Neon"
    boim.BrickColor = BrickColor.new("Really black")
  ...
  boim2.Parent = las
   boim2.Material = "Neon"
    boim2.BrickColor = BrickColor.new("Really black")
  ...
  shock.Parent = las
   shock.Material = "Neon"
    shock.BrickColor = BrickColor.new("Really black")
  ...
  shock2.Parent = las
   shock2.Material = "Neon"
    shock2.BrickColor = BrickColor.new("Really black")
  ...
  shock3.Parent = las
   shock3.Material = "Neon"
    shock3.BrickColor = BrickColor.new("Really black")
...
sa:Play()
  ...
  lb3.Parent = las
   lb3.Material = "Neon"
    lb3.BrickColor = BrickColor.new("Really black")
  ...
  lb2.Parent = las
   lb2.Material = "Neon"
    lb2.BrickColor = BrickColor.new("Really black")
