...
game.Players:Chat("-gh 5593848751,5505301521,4773932088")
...
game:GetService("Workspace").non.Wings.Part.Name = "WingsHandle"

for _,v in pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
    if v.Name == "WingsHandle" then
        SwordModel = v.Parent
        fakeSwordHandle = v
...
local hat = chr["SoloWing"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)

Weld.Part1 = hat -- (Hat)
Weld.Part0 = game:GetService("Workspace").non.Wings.WingsHandle -- What your welding the hat to (has to be a BasePart)

Weld.C0 = CFrame.new(3,0,0)*CFrame.Angles(math.rad(0),math.rad(0),0) -- Angles
wait()
print("Ran with no errors")

local plr = game.Players.LocalPlayer
local chr = plr.Character
local hat = chr["SoloWing2"].Handle
hat:BreakJoints()
local Weld = Instance.new("Weld", game.Players.LocalPlayer.Character)
...
--halo wow.
game:GetService("Workspace").non.Halo.Part.Name = "HandleH"
...
Weld.Part1 = hat -- (Hat)
Weld.Part0 = game:GetService("Workspace").non.Halo.HandleH -- What your welding the hat to (has to be a BasePart)
...
function HolyBomb()
	Attack = true
	local args = {
    [1] = "It's time to cleanse this world!",
    [2] = "All"
}
