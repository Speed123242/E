...
game.Players:Chat("-gh 5621592566")
wait()
-----------/EXCALIBUR\------------
...
Part3.BrickColor = BrickColor.new("Red")
...
Part7.BrickColor = BrickColor.new("Red")
...
WedgePart24.BrickColor = BrickColor.new("Red")
...
WedgePart26.BrickColor = BrickColor.new("Red")
...
WedgePart28.BrickColor = BrickColor.new("Red")
...
WedgePart30.BrickColor = BrickColor.new("Red")
...
--path:   game:GetService("Workspace").non.Excalibur.Part
for _,v in pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
    if v.Name == "handleP" then
        SwordModel = v.Parent
        fakeSwordHandle = v
        for _,x in pairs(SwordModel:GetDescendants()) do
...
game.Players.LocalPlayer.Character.Excalibur:FindFirstChild("Part").Name = "GetMe"
...
local hat = Align(char['Cursed Katana Accessory'].Handle,game:GetService("Workspace").non.Excalibur.handleP,false)
local cf = game:GetService("Workspace").non.Excalibur.handleP.CFrame*CFrame.new(-0.5,0,-2.50)*CFrame.Angles(math.rad(90),math.rad(5),80)
hat[1].CFrame = cf:Inverse() * game:GetService("Workspace").non.Excalibur.handleP.CFrame
spawn(function()
    		...
    		tdmg = bladeP.Touched:connect(function(hit)
    			if cut == true and Slashing == true and hit.Parent:FindFirstChildOfClass("Humanoid") and not hit:IsDescendantOf(char) and hit.Name ~= "scar" then
            		...
            		for i = 0,0 do
            			...
            			scar.Anchored = true
            			scar.Material = "Neon"
            			scar.BrickColor = BrickColor.new("Red")
...
function longSlash()
	if lSlashing == false and attacking == false then
		...
		slashp.BrickColor = BrickColor.new("Red")
		...
		slashp.Touched:connect(function(hit)
			if shoot == true and hit.Parent:FindFirstChildOfClass("Humanoid") and not hit:IsDescendantOf(char) then
				...
				for i = 1,15 do
					...
					scar2.Anchored = true
					scar2.Material = "Neon"
					scar2.BrickColor = BrickColor.new("Red")
					...
					cutSparkle.BrickColor  = BrickColor.new("Red")
...
function SwordSlam()
	if Slamming == false and attacking == false then
		...
		for i = 1,30 do
			...
			FIRE.Material = "Neon"
			FIRE.BrickColor = BrickColor.new("Red")
			...
			FIRE2.Material = "Neon"
			FIRE2.BrickColor = BrickColor.new("Red")
