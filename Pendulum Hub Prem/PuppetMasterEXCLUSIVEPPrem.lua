--emper pro converter tescesuz bad haha ezszzz
----EXCLUSIVE SCRIPT FOR PENDULUM----
game.Players:Chat("-re")--i am being slow time to go fast
wait(0.5)
game.Players:Chat("-gh 7170680556,7250579896")--i am being slow time to go fast
wait(0.5)
...
local hat = Align(char['White SS'].Handle,game:GetService("Workspace").non.Part,false)
local cf = game:GetService("Workspace").non.Part.CFrame*CFrame.new(0, 0, 0)*CFrame.Angles(math.rad(140),math.rad(0),0)
hat[1].CFrame = cf:Inverse() * game:GetService("Workspace").non.Part.CFrame
spawn(function()
