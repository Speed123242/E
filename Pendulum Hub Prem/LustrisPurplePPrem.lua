...
wait(0.5)
game.Players:Chat("-gh 6964082275,6904794619")
wait()
...
local cf = char['Right Arm'].CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(29),math.rad(0),0)
...
local hat = Align(char['swordhalo'].Handle,char['Right Arm'],false)
local cf = char['Right Arm'].CFrame*CFrame.new(0,0.50,2)*CFrame.Angles(math.rad(0),math.rad(0),0)
hat[1].CFrame = cf:Inverse() * char['Right Arm'].CFrame
spawn(function()
    char.AncestryChanged:wait()--if you respawn, it will stop the  loop to avoid lag of using it over and over
    _G.loop = false 
...
game.Players.LocalPlayer.Character.WeaponModel:FindFirstChild("Handle").Name = "Destroyed"

game:GetService("Workspace").non.WeaponModel:Destroy()
